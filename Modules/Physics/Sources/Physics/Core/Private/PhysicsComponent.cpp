...
physx::PxRigidActor* PhysicsComponent::GetPxActor() const
{
    return actor;
}
...
void PhysicsComponent::SetPxActor(physx::PxRigidActor* actor_)
{
...
DAVA_VIRTUAL_REFLECTION_IMPL(PhysicsComponent)
{
    ...
    .Field("BodyFlags", &PhysicsComponent::GetBodyFlags, &PhysicsComponent::SetBodyFlags)[M::Replicable(), M::FlagsT<PhysicsComponent::eBodyFlags>()]
    .End();
}
