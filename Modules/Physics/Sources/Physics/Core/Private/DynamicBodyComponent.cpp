...
void DynamicBodyComponent::Serialize(KeyedArchive* archive, SerializationContext* serializationContext)
{
    ...
    archive->SetBool("dynamicBody.isKinematic", isKinematic);
}
...
void DynamicBodyComponent::Deserialize(KeyedArchive* archive, SerializationContext* serializationContext)
{
    ...
    isKinematic = archive->GetBool("dynamicBody.isKinematic", isKinematic);
}
...
void DynamicBodyComponent::SetLinearVelocity(const Vector3& v)
{
    linearVelocity = v;
    ScheduleUpdate();
}

Vector3 DynamicBodyComponent::GetLinearVelocity() const
{
    return linearVelocity;
}

void DynamicBodyComponent::SetAngularVelocity(const Vector3& v)
{
    angularVelocity = v;
    ScheduleUpdate();
}

Vector3 DynamicBodyComponent::GetAngularVelocity() const
{
...
void DynamicBodyComponent::SetIsKinematic(bool value)
{
    isKinematic = value;
    ScheduleUpdate();
}

bool DynamicBodyComponent::GetIsKinematic() const
{
    return isKinematic;
}
