Physics module use NVidia physx library for collision detection and physics simulation

Integretion problems:
- physx library use C limit macroses. To compile physx or project that use physx on android there should be defined \__STDC_LIMIT_MACROS
  before stdint.h will be included (on Window and Apple's platforms limit macroses defined with out #ifdef). As DAVA include cstdint -> stdint.h in
