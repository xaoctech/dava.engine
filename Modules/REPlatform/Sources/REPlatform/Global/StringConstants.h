...
static const String LAYER_NODE_NAME = String("Layer");
...
static const String EDITOR_LIGHT_PROBE = String("editor.lightProbe");
static const String EDITOR_SKY = String("editor.sky");
static const String EDITOR_SUN_LIGHT = String("editor.sunLight");
static const String EDITOR_POSTEFFECT = String("editor.posteffect");
...
static const String LANDSCAPE_EDITOR_SYSTEM_TILEMASK_TEXTURES_DIMENSIONS_DOES_NOT_MATCH = "Warning: tile textures dimensions does not match.";
