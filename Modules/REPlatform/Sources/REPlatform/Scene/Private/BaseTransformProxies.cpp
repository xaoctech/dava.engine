...
const Matrix4& EntityTransformProxy::GetLocalTransform(const Any& object)
{
    Selectable obj(object);
    DVASSERT(obj.CanBeCastedTo<Entity>());
...
const Matrix4& EmitterTransformProxy::GetLocalTransform(const Any& object)
{
    static Matrix4 currentMatrix;
    currentMatrix.Identity();
...
const Matrix4& ParticleForceTransformProxy::GetLocalTransform(const Any& object)
{
    static Matrix4 currentMatrix;
    currentMatrix.Identity();
