...
void CollectDecorationPathname(Scene* scene, const FilePath& dataSourceFolder, SceneExporter::ExportedObjectCollection& exportedObjects)
{
    Landscape* landscape = FindLandscape(scene);
    if (landscape != nullptr)
    {
...
void SceneExporter::CollectObjects(Scene* scene, Vector<ExportedObjectCollection>& exportedObjects)
{
    ...
    SceneExporterDetails::CollectDecorationPathname(scene, exportingParams.dataSourceFolder, exportedObjects[eExportedObjectType::OBJECT_SCENE]);
