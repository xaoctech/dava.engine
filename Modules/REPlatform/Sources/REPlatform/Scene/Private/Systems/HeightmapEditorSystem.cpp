...
void HeightmapEditorSystem::StoreOriginalHeightmap()
{
    ...
    originalHeightmap = editorHeightmap->GetHeightmap()->Clone(NULL);
...
{
    return drawSystem->GetHeightmapProxy()->GetHeightmap()->Size() * Vector2(cursorPosition.x, 1.f - cursorPosition.y);
}
} // namespace DAVA
