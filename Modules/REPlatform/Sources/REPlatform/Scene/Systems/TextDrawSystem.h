...
public:
    ...
    void DrawTextLines(const Vector2& pos2d, const Vector<String>& lines, const Color& color, Align align = Align::TopLeft);
    void DrawTextLines(const Vector2& pos2d, const Vector<WideString>& lines, const Color& color, Align align = Align::TopLeft);
