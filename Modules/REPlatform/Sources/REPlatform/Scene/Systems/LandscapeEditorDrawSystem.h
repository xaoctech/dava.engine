...
public:
    enum eErrorType
    {
        ...
        LANDSCAPE_EDITOR_SYSTEM_TILEMASK_TEXTURES_DIMENSIONS_DOES_NOT_MATCH
    };
    ...
    float32 GetTextureSize(uint32 layerIndex, const FastName& level);
    ...
    Rect GetTextureRect(uint32 layerIndex, const FastName& level);
...
private:
    ...
    Vector<FilePath> sourceTilemaskPath;
};
} // namespace DAVA
