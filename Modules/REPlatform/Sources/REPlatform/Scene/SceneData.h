...
class SceneData : public DAVA::TArcDataNode
{
public:
...
private:
    ...
    DAVA_VIRTUAL_REFLECTION_IN_PLACE(SceneData, DAVA::TArcDataNode)
    {
...
class GlobalSceneSettings : public DAVA::SettingsNode
{
public:
    ...
    DAVA_VIRTUAL_REFLECTION(GlobalSceneSettings, DAVA::SettingsNode);
};
