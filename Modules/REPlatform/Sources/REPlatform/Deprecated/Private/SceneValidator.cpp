...
void SceneValidator::ValidateLandscape(Landscape* landscape)
{
    ...
    ValidateLandscapeTexture(landscape, Landscape::TEXTURE_ALBEDO_TILE0);
    ValidateLandscapeTexture(landscape, Landscape::TEXTURE_ALBEDO_TILE1);
    ValidateLandscapeTexture(landscape, Landscape::TEXTURE_ALBEDO_TILE2);
    ValidateLandscapeTexture(landscape, Landscape::TEXTURE_ALBEDO_TILE3);
