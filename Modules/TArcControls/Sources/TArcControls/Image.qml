...
Image {
    ...
    Image {
        ...
        height: lastImageHeight != 0 ? lastImageHeight : image.parent != null ? (Math.min(sourceSize.height, image.parent.height)) : sourceSize.height
        width: lastImageWidth != 0 ? lastImageWidth : image.parent != null ? (Math.min(sourceSize.width, image.parent.width)) : sourceSize.width
