...
ButtonStyle
{
    ...
    property int __menuPadding: (control.menu !== null && control.iconSource == "") ? 5 : 0
    ...
    label: Item
    {
        ...
        Row
        {
            ...
            Item
            {
                ...
                width: conrol.iconSource ? icon.width : 0
                height: conrol.iconSource ? icon.height : 0
                ...
                Image
                {
                    id: dropDownArrow
                    anchors.verticalCenter: parent.verticalCenter
                    source: "qrc:/Styles/DropDownArrow_16x16.png"
                    z: 1
