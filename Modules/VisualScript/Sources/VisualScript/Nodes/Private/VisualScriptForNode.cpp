...
VisualScriptForNode::VisualScriptForNode()
{
    ...
    firstIndexPin = RegisterPin(new VisualScriptPin(this, VisualScriptPin::Attribute::ATTR_IN, FastName("first index"), Type::Instance<int32>()));
    lastIndexPin = RegisterPin(new VisualScriptPin(this, VisualScriptPin::Attribute::ATTR_IN, FastName("last index"), Type::Instance<int32>()));
    breakPin = RegisterPin(new VisualScriptPin(this, VisualScriptPin::Attribute::EXEC_IN, FastName("break"), nullptr));
    ...
    indexPin = RegisterPin(new VisualScriptPin(this, VisualScriptPin::Attribute::ATTR_OUT, FastName("index"), Type::Instance<int32>()));
