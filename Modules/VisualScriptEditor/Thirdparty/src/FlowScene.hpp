...
public:
  ...
  virtual void SaveRuntime() const = 0;
  virtual void LoadRuntime() = 0;

  virtual void NodeWillBeRemoved(NodeDataModel* model) = 0;
...
signals:
  ...
  void nodeContextMenu(Node& n, const QPointF& pos);
    ...
    void sceneContextMenuRequested(const QPointF& scenePos, const QPoint& globalPos, const QString& filter);
