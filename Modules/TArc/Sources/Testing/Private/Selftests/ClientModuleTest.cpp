...
#include "Testing/MockClientModule.h"
...
DAVA_TARC_TESTCLASS(ClientModuleTest)
{
    ...
    DAVA_TEST(CreateContextTest)
    {
        ...
        EXPECT_CALL(*MockClientModule<CMTTag>::instance, OnContextCreated(_)).WillOnce(Invoke(fn));
    ...
    DAVA_TEST(ActivateContext)
    {
        ...
        EXPECT_CALL(*MockClientModule<CMTTag>::instance, OnContextCreated(_)).WillOnce(Invoke(fn));
        EXPECT_CALL(*MockClientModule<CMTTag>::instance, OnContextDeleted(_)).WillOnce(Invoke(verifyFn));
