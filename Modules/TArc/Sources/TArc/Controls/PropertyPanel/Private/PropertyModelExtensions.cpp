...
void ModifyExtension::RemoveField(const Reflection& collection, const Any& key)
{
    GetNext<ModifyExtension>()->RemoveField(collection, key);
}
...
void ModifyExtension::MultiCommandInterface::RemoveField(const Reflection& collection, const Any& key)
{
    extension->RemoveField(collection, key);
}
