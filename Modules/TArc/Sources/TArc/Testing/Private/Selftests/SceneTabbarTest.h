...
public:
    ...
    DAVA_VIRTUAL_REFLECTION_INPLACE(TabsModel, DAVA::TArc::DataNode)
    {
...
public:
    ...
    DAVA_VIRTUAL_REFLECTION_INPLACE(TabbarModule, DAVA::TArc::MockClientModule, DAVA::Singleton<TabbarModule>)
    {
