...
void NetworkReplicationSystem::ProcessFixed(float32 timeElapsed)
{
    DAVA_PROFILER_CPU_SCOPE("NetworkReplicationSystem::ProcessFixed");
    ...
    if (!deltas.empty())
    {
        ...
        {
            DAVA_PROFILER_CPU_SCOPE("NetworkReplicationSystem::ApplyDiff");
        ...
        {
            DAVA_PROFILER_CPU_SCOPE("NetworkReplicationSystem::ApplyReplication");
...
void NetworkReplicationSystem::PrepareForRemove()
{
}

void NetworkReplicationSystem::ApplyDiffCallback(uint32 frameId, SnapshotApplyParam& param)
{
    switch (param.cmd)
    {
...
void NetworkReplicationSystem::ApplySnapshotWithoutPrediction(Entity* entity, Snapshot* snapshot)
{
...
void NetworkReplicationSystem::UpdateReplicationInfo(NetworkID entityId, uint32 frameId, bool isChanged)
{
...
void NetworkReplicationSystem::AddPendingEntity(Entity* entity, Entity* parent)
{
...
void NetworkReplicationSystem::RemovePendingEntity(Entity* entity)
{
...
Entity* NetworkReplicationSystem::GetPendingEntityParent(Entity* entity)
{
...
void NetworkReplicationSystem::AddPendingComponent(Entity* entity, Component* component, SnapshotComponentKey key)
{
...
void NetworkReplicationSystem::RemovePendingComponent(Entity* entity, SnapshotComponentKey key)
{
...
void NetworkReplicationSystem::RemovePendingComponents(Entity* entity)
{
    auto it = pendingAddComponent.find(entity);
    if (it != pendingAddComponent.end())
    {
