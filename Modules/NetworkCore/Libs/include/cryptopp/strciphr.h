...
public:
    ...
    {
        return (unsigned int)this->m_leftOver;
    }
...
struct CRYPTOPP_NO_VTABLE CFB_CipherConcretePolicy : public BASE
{
    ...
    {
        this->Iterate(NULL, NULL, ENCRYPTION, 1);
    }
...
public:
    ...
    unsigned int GetOptimalNextBlockSize() const
    {
        return (unsigned int)m_leftOver;
    }
...
public:
    ...
    {
        return static_cast<SymmetricCipher*>(new SymmetricCipherFinal<BASE, INFO>(*this));
    }
};
