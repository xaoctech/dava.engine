...
public:
    ...
    CRYPTOPP_CONSTEXPR static const char* StaticAlgorithmName()
    {
        return BLAKE2_Info<T_64bit>::StaticAlgorithmName();
    }
    ...
    {
        return std::string(StaticAlgorithmName()) + "-" + IntToString(this->DigestSize() * 8);
    }
    ...
    {
        return (CRYPTOPP_BOOL_ALIGN16 ? 16 : GetAlignmentOf<W>());
    }
