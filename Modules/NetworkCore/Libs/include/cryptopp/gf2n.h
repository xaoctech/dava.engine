...
public:
    ...
    public:
        DivideByZero()
            : Exception(OTHER_ERROR, "PolynomialMod2: division by zero")
        {
        }
    };
...
//!
inline CryptoPP::PolynomialMod2 operator&(const CryptoPP::PolynomialMod2& a, const CryptoPP::PolynomialMod2& b)
{
    return a.And(b);
}
//!
...
//!
inline CryptoPP::PolynomialMod2
operator+(const CryptoPP::PolynomialMod2& a, const CryptoPP::PolynomialMod2& b)
{
    return a.Plus(b);
}
//!
...
public:
    ...
    {
        return new GF2NP(*this);
    }
    virtual void DEREncode(BufferedTransformation& bt) const
    {
        CRYPTOPP_UNUSED(bt);
        CRYPTOPP_ASSERT(false);
    } // no ASN.1 syntax yet for general polynomial basis
    ...
    {
        CRYPTOPP_ASSERT(a.Degree() < m_modulus.Degree());
        return !!a;
    }
...
public:
    ...
    GF2NPP(unsigned int t0, unsigned int t1, unsigned int t2, unsigned int t3, unsigned int t4)
        : GF2NP(PolynomialMod2::Pentanomial(t0, t1, t2, t3, t4))
        , t0(t0)
        , t1(t1)
        , t2(t2)
        , t3(t3)
