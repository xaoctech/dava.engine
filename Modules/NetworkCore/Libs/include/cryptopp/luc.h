...
public:
    ...
    {
        CRYPTOPP_UNUSED(group);
        CRYPTOPP_UNUSED(maxExpBits);
        CRYPTOPP_UNUSED(storage);
    }
    ...
    {
        CRYPTOPP_UNUSED(group);
        CRYPTOPP_UNUSED(exponent);
        CRYPTOPP_UNUSED(pc2);
        CRYPTOPP_UNUSED(exponent2);
        // shouldn't be called
...
public:
    ...
    {
        CRYPTOPP_UNUSED(element1);
        CRYPTOPP_UNUSED(exponent1);
        CRYPTOPP_UNUSED(element2);
        CRYPTOPP_UNUSED(exponent2);
        throw NotImplemented("LUC_GroupParameters: MultiplyElements can not be implemented");
    }
