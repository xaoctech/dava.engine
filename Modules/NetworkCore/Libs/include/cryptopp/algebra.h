...
template <class T>
class CRYPTOPP_NO_VTABLE AbstractGroup
{
public:
    typedef T Element;
...
//!   <pre>    abcd = group.Add(a, group.Add(b, group.Add(c,d));</pre>
template <class T>
class CRYPTOPP_NO_VTABLE AbstractRing : public AbstractGroup<T>
{
public:
    typedef T Element;
...
//!   <pre>    abcd = group.Add(a, group.Add(b, group.Add(c,d));</pre>
template <class T>
class CRYPTOPP_NO_VTABLE AbstractEuclideanDomain : public AbstractRing<T>
{
public:
    typedef T Element;
...
//!   <pre>    abcd = group.Add(a, group.Add(b, group.Add(c,d));</pre>
template <class T>
class EuclideanDomainOf : public AbstractEuclideanDomain<T>
{
public:
    typedef T Element;
...
//!   <pre>    abcd = group.Add(a, group.Add(b, group.Add(c,d));</pre>
template <class T>
class QuotientRing : public AbstractRing<typename T::Element>
{
public:
