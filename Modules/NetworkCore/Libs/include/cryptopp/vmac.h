...
public:
    ...
    {
        return std::string("VMAC(") + GetCipher().AlgorithmName() + ")-" + IntToString(DigestSize() * 8);
    }
...
protected:
    ...
    {
        return const_cast<VMAC_Base*>(this)->AccessCipher();
    }
...
public:
    ...
    {
        return std::string("VMAC(") + T_BlockCipher::StaticAlgorithmName() + ")-" + IntToString(T_DigestBitSize);
    }
