...
public:
    NonblockingSource(BufferedTransformation* attachment)
        : m_messageEndSent(false)
        , m_doPumpBlocked(false)
...
public:
    ...
    {
        return false;
    } // implement if MustWaitForEof() == true
};
...
protected:
    ...
    {
        return const_cast<NetworkSource*>(this)->AccessReceiver();
    }
...
public:
    ...
    void SetMaxBufferSize(size_t maxBufferSize)
    {
        ...
        m_buffer.SetNodeSize(UnsignedMin(maxBufferSize, 16U * 1024U + 256U));
    }
    void SetAutoFlushBound(size_t bound)
    {
        m_autoFlushBound = bound;
    }
    ...
    {
        return (size_t)m_buffer.CurrentSize();
    }
...
protected:
    ...
    {
        return const_cast<NetworkSink*>(this)->AccessSender();
    }
