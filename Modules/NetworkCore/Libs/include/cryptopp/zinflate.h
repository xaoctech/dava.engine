...
public:
    ...
    public:
        Err(const std::string& what)
            : Exception(INVALID_DATA_FORMAT, "HuffmanDecoder: " + what)
        {
        }
    };
...
private:
    ...
    struct CodeInfo
    {
        ...
        inline bool operator<(const CodeInfo& rhs) const
        {
