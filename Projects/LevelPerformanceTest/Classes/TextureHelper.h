...
public:
	...
	static DAVA::uint32 GetSceneTextureFilesSize(DAVA::Scene* scene, const String& scenePath);

private:
	static DAVA::uint32 EnumerateSceneTextures(DAVA::Scene* scene, const String& scenePath);
	static DAVA::uint32 EnumerateSceneTexturesFileSize(DAVA::Scene* scene, const String& scenePath);
