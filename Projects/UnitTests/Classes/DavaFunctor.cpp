// DavaFunctor.cpp : Defines the entry point for the console application.
//
...
{
#ifdef TEST_VERBOSE
	res ? printf("[OK] - line %u\n", line) : printf("[Failed] - line %u, expressin: { %s }\n", line, str);
#else
	if (!res) printf("[Failed] - line %u\n", line);
#endif
}
