...
# ResourceEditor.exe -sceneexporter -export -indir /projects/wot.mobile/DataSource/3d/ -outdir /projects/wot.mobile/Data/3d/ -processfile Maps/level_mp_2_92.sc2
# ResourceEditor.exe -sceneexporter -export -indir /projects/wot.mobile/DataSource/3d/ -outdir /projects/wot.mobile/Data/3d/ -processfile Tanks/German/tiger_sniper.sc2
...
def main_convert_3d(): # it's function for external usage
    ...
    for i in range(0, len(processing)):
        ...
        params = [executable, '-sceneexporter', '-export', '-indir', dataSourceDir, '-outdir', dataDir, '-processfile', processing[i], '-qualitycfgpath', qualityConfigPath, '-forceclose']
