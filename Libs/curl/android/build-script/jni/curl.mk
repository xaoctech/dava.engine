...
CURL_COMMON_CFLAGS += \
  ...
  -Wno-unused-function 
CURL_CSOURCES := \
  amigaos.c asyn-ares.c asyn-thread.c axtls.c base64.c bundles.c conncache.c \
  ...
  curl_sasl.c curl_schannel.c curl_sspi.c curl_threads.c cyassl.c dict.c dotdot.c \
  easy.c escape.c file.c fileinfo.c formdata.c ftp.c ftplistparser.c \
  getenv.c getinfo.c gopher.c gskit.c gtls.c hash.c hmac.c hostasyn.c hostcheck.c \
  ...
  nwlib.c nss.c nwlib.c nwos.c openldap.c parsedate.c pingpong.c pipeline.c polarssl.c polarssl_threadlock.c pop3.c \
  progress.c qssl.c rawstr.c rtsp.c security.c select.c sendf.c share.c slist.c \
  smtp.c socks.c socks_gssapi.c socks_sspi.c speedcheck.c splay.c ssh.c \
  sslgen.c ssluse.c strdup.c strequal.c strerror.c strtok.c strtoofft.c telnet.c tftp.c \
