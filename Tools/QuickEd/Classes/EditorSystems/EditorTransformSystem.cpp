...
{
    Vector<EditorTransformSystem_local::ChangePropertyAction> propertiesToChange;
    ...
    for (const EditorTransformSystem_local::ChangePropertyAction& changePropertyAction : propertiesToChange)
    {
