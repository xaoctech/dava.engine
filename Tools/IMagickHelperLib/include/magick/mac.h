...
#if defined(DISABLE_SIOUX)
typedef void (*MACEventHookPtr)(const char*);

typedef void (*MACErrorHookPtr)(const short, const char* text);
...
#if !defined(_MAGICKCORE_POSIX_SUPPORT_VERSION)
extern MagickExport DIR* opendir(const char*);

extern MagickExport long
telldir(DIR*);

extern MagickExport struct dirent* readdir(DIR*);
