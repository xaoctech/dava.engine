...
typedef MagickBooleanType (*DuplexTransferPixelViewMethod)(const PixelView*, const PixelView*,
                                                           PixelView*, void*),
...
extern WandExport char* GetPixelViewException(const PixelView*, ExceptionType*)
...
extern WandExport DrawInfo* DrawPeekGraphicWand(const DrawingWand*) magick_attribute((deprecated));
...
extern WandExport unsigned char* MagickWriteImageBlob(MagickWand*, size_t*) magick_attribute((deprecated));
