...
typedef MagickBooleanType (*MonitorHandler)(const char*, const MagickOffsetType, const MagickSizeType,
                                            ExceptionInfo*);
...
extern MagickExport FILE* OpenMagickStream(const char*, const char*);
