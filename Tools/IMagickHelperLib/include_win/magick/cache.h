...
extern MagickExport const IndexPacket* GetVirtualIndexQueue(const Image*);
...
extern MagickExport const void* AcquirePixelCachePixels(const Image*, MagickSizeType*, ExceptionInfo*);
