...
extern WandExport ChannelFeatures* MagickGetImageChannelFeatures(MagickWand*, const size_t);

extern WandExport ChannelStatistics* MagickGetImageChannelStatistics(MagickWand*);
...
extern WandExport PixelWand** MagickGetImageHistogram(MagickWand*, size_t*);
