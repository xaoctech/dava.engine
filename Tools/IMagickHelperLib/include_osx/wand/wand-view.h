...
typedef MagickBooleanType (*DuplexTransferWandViewMethod)(const WandView*, const WandView*, WandView*,
...
extern WandExport char* GetWandViewException(const WandView*, ExceptionType*);
...
extern WandExport MagickWand* GetWandViewWand(const WandView*);

extern WandExport PixelWand** GetWandViewPixels(const WandView*);
