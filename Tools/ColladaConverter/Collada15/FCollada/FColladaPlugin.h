...
public:
    ...
    {
        FUAssert(index < archivePlugins.size(), return NULL);
        return archivePlugins[index];
    }
    ...
    DEPRECATED(3.05A, RegisterPlugin)
    inline bool AddPlugin(FCPExtraTechnique* plugin)
    {
        return RegisterPlugin(plugin);
    } /**< See above. */
    DEPRECATED(3.05A, RegisterPlugin)
    inline bool AddArchivePlugin(FCPArchive* plugin)
    {
        return RegisterPlugin(plugin);
    } /**< See above. */
    ...
    DEPRECATED(3.05A, LoadDocumentFromFile)
    inline bool LoadDocument(FCDocument* document, const fchar* filename)
    {
        return LoadDocumentFromFile(document, filename);
    } /**< See above. */
    ...
    DEPRECATED(3.05A, SaveDocumentToFile)
    inline bool SaveDocument(FCDocument* document, const fchar* filename)
    {
        return SaveDocumentToFile(document, filename);
    } /**< See above. */
