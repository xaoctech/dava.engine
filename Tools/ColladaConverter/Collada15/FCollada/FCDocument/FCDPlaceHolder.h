...
public:
    ...
    inline FCDocument* GetTarget() const
    {
        return target;
    }
    ...
    inline bool IsTargetLoaded() const
    {
        return target != NULL;
    }
    ...
    inline void AddExternalReference(FCDEntityReference* reference)
    {
    ...
    inline void RemoveExternalReference(FCDEntityReference* reference)
    {
    ...
    inline size_t GetExternalReferenceCount() const
    {
    ...
    {
        FUAssert(index < GetExternalReferenceCount(), return NULL);
