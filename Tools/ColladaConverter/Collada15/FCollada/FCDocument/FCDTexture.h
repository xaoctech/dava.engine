...
#if defined(WIN32)
template <class T>
class FCOLLADA_EXPORT FCDEffectParameterT; /**< Trick Doxygen. */
#elif defined(LINUX) || defined(__APPLE__)
template <class T>
class FCDEffectParameterT; /**< Trick Doxygen. */
#endif // LINUX
...
public:
    ...
    inline FCDImage* GetImage()
    {
        return const_cast<FCDImage*>(const_cast<const FCDTexture*>(this)->GetImage());
    }
    ...
    inline const FCDEffectParameterSampler* GetSampler() const
    {
        return sampler;
    } /**< See above. */
    ...
    inline void SetSampler(FCDEffectParameterSampler* _sampler)
    {
        sampler = _sampler;
    }
    ...
    inline FCDEffectParameterInt* GetSet()
    {
        return set;
    }
    inline const FCDEffectParameterInt* GetSet() const
    {
        return set;
    } /**< See above. */
