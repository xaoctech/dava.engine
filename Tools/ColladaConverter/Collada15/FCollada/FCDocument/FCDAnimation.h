...
public:
    ...
    inline FCDAnimation* GetParent()
    {
        return parent;
    }
    inline const FCDAnimation* GetParent() const
    {
        return parent;
    } /**< See above. */
    ...
    {
        return const_cast<FCDEntity*>(const_cast<const FCDAnimation*>(this)->FindDaeId(daeId));
    }
    ...
    inline FCDAnimation* GetChild(size_t index)
    {
        FUAssert(index < children.size(), return NULL);
        return children.at(index);
    }
    inline const FCDAnimation* GetChild(size_t index) const
    {
        FUAssert(index < children.size(), return NULL);
        return children.at(index);
    } /**< See above. */
    ...
    {
        FUAssert(index < GetChannelCount(), return NULL);
