...
public:
	...
	*/
    ...
    {
        return physicsModelInstances.size();
    };
    ...
    {
        FUAssert(index < GetPhysicsModelInstancesCount(), return NULL);
        return physicsModelInstances.at(index);
    }
    ...
    {
        return forceFieldInstances.size();
    };
    ...
    {
        FUAssert(index < GetForceFieldInstancesCount(), return NULL);
        return forceFieldInstances.at(index);
    }
