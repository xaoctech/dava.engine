...
public:
    ...
    {
        FUAssert(index < GetProfileCount(), return NULL);
    ...
    DEPRECATED(3.05A, GetProfileCount and GetProfile(index))
    void GetProfiles() const
    {
    }
    ...
    inline FCDEffectProfile* FindProfile(FUDaeProfileType::Type type)
    {
        return const_cast<FCDEffectProfile*>(const_cast<const FCDEffect*>(this)->FindProfile(type));
    } /**< See above. */
    ...
    /** Retrieves the profile for a specific profile type and platform.
		...
		@return The profile of this type. This pointer will be NULL if the effect
			does not have any profile of this type. */
    inline FCDEffectProfile* FindProfileByTypeAndPlatform(FUDaeProfileType::Type type, const fm::string& platform)
    {
        return const_cast<FCDEffectProfile*>(const_cast<const FCDEffect*>(this)->FindProfileByTypeAndPlatform(type, platform));
    }
    ...
    inline bool HasProfile(FUDaeProfileType::Type type) const
    {
        return FindProfile(type) != NULL;
    }
