...
public:
    ...
    inline FCDGeometryMesh* GetParent()
    {
        return parent;
    }
    inline const FCDGeometryMesh* GetParent() const
    {
        return parent;
    } /**< See above. */
    ...
    {
        return const_cast<FCDGeometryPolygons*>(this)->GetExtra();
    } /**< See above. */
    ...
    inline const uint32* GetFaceVertexCounts() const
    {
        return faceVertexCounts.begin();
    } /**< See above. */
    ...
    inline size_t GetFaceVertexCountCount() const
    {
    ...
    inline size_t GetHoleCount() const
    {
        return holeFaces.size();
    }
    ...
    {
        return faceVertexCounts.size() - GetHoleCount();
    }
    ...
    inline size_t GetFaceOffset() const
    {
        return faceOffset;
    }
    ...
    inline size_t GetFaceVertexOffset() const
    {
        return faceVertexOffset;
    }

    /** Retrieves the number of holes which appear before this polygon set.
		This value is useful when traversing all the face-vertex pairs of a geometric mesh. */
    inline size_t GetHoleOffset() const
    {
        return holeOffset;
    }
    ...
    inline void SetFaceOffset(size_t offset)
    {
        faceOffset = offset;
        SetDirtyFlag();
    }
    ...
    inline void SetFaceVertexOffset(size_t offset)
    {
        faceVertexOffset = offset;
        SetDirtyFlag();
    }
    ...
    inline void SetHoleOffset(size_t offset)
    {
        holeOffset = offset;
        SetDirtyFlag();
    }
    ...
    DEPRECATED(3.05A, GetInputCount and GetInput(index))
    void GetInputs()
    {
    }
    ...
    inline size_t GetInputCount() const
    {
        return inputs.size();
    }
    ...
    inline FCDGeometryPolygonsInput* GetInput(size_t index)
    {
        FUAssert(index < GetInputCount(), return NULL);
        return inputs.at(index);
    }
    inline const FCDGeometryPolygonsInput* GetInput(size_t index) const
    {
        FUAssert(index < GetInputCount(), return NULL);
        return inputs.at(index);
    } /**< See above. */
    ...
    inline size_t GetHoleFaceCount() const
    {
        return holeFaces.size();
    }
    ...
    inline const uint32* GetHoleFaces() const
    {
        return holeFaces.begin();
    } /**< See above. */
    ...
    inline void FindInputs(FUDaeGeometryInput::Semantic semantic, FCDGeometryPolygonsInputList& inputs)
    {
        const_cast<FCDGeometryPolygons*>(this)->FindInputs(semantic, *(FCDGeometryPolygonsInputConstList*)&inputs);
    }
    ...
    inline const fstring& GetMaterialSemantic() const
    {
    ...
    inline void SetMaterialSemantic(const fchar* semantic)
    {
        materialSemantic = semantic;
        SetDirtyFlag();
    }
    inline void SetMaterialSemantic(const fstring& semantic)
    {
        materialSemantic = semantic;
        SetDirtyFlag();
    } /**< See above. */
