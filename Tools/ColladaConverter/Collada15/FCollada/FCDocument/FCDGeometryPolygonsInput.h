...
public:
    ...
    uint32* GetIndices()
    {
        return const_cast<uint32*>(const_cast<const FCDGeometryPolygonsInput*>(this)->GetIndices());
    }
...
private:
    ...
    FUParameterUInt32List& FindIndices()
    {
        return const_cast<FUParameterUInt32List&>(const_cast<const FCDGeometryPolygonsInput*>(this)->FindIndices());
    }
