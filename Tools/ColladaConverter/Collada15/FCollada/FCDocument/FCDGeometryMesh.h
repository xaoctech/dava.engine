...
public:
    ...
    inline void SetConvex(bool _isConvex)
    {
        isConvex = _isConvex;
        SetDirtyFlag();
    }
    ...
    inline bool GetConvexify() const
    {
        return convexify;
    }
    ...
    inline void SetConvexify(bool _convexify)
    {
        convexify = _convexify;
        SetDirtyFlag();
    }
    ...
    inline FCDGeometryMesh* FindConvexHullOfMesh()
    {
        return const_cast<FCDGeometryMesh*>(const_cast<const FCDGeometryMesh*>(this)->FindConvexHullOfMesh());
    }
	...
	*/
    ...
    inline size_t GetPolygonsCount() const
    {
    ...
    inline FCDGeometryPolygons* GetPolygons(size_t index)
    {
        FUAssert(index < GetPolygonsCount(), return NULL);
        return polygons.at(index);
    }
    inline const FCDGeometryPolygons* GetPolygons(size_t index) const
    {
        FUAssert(index < GetPolygonsCount(), return NULL);
        return polygons.at(index);
    } /**< See above. */
    ...
    DEPRECATED(3.05A, GetVertexSourceCount and GetVertexSource(index))
    void GetVertexSources() const
    {
    }
    ...
    inline size_t GetVertexSourceCount() const
    {
        return vertexSources.size();
    }
    ...
    inline FCDGeometrySource* GetVertexSource(size_t index)
    {
        FUAssert(index < GetVertexSourceCount(), return NULL);
        return vertexSources.at(index);
    }
    inline const FCDGeometrySource* GetVertexSource(size_t index) const
    {
        FUAssert(index < GetVertexSourceCount(), return NULL);
        return vertexSources.at(index);
    } /**< See above. */
    ...
    inline bool IsVertexSource(const FCDGeometrySource* source) const
    {
        return vertexSources.contains(const_cast<FCDGeometrySource*>(source));
    }
    ...
    {
        FindSourcesByType(type, *(FCDGeometrySourceConstList*)&sources);
    }
    ...
    {
        return FindSourceByType(FUDaeGeometryInput::POSITION);
    }
    ...
    DEPRECATED(3.05A, GetSourceCount and GetSource(index))
    ...
    inline size_t GetSourceCount() const
    {
        return sources.size();
    }
    ...
    inline FCDGeometrySource* GetSource(size_t index)
    {
        FUAssert(index < GetSourceCount(), return NULL);
        return sources.at(index);
    }
    inline const FCDGeometrySource* GetSource(size_t index) const
    {
        FUAssert(index < GetSourceCount(), return NULL);
        return sources.at(index);
    } /**< See above. */
