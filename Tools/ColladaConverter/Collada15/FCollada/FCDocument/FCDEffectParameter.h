...
public:
    ...
    inline const fm::string& GetReference() const
    {
        return reference;
    }
    ...
    /** Retrieves the semantic for this effect parameter.
		@return The semantic. */
    inline const fm::string& GetSemantic() const
    {
        return semantic;
    }
    ...
    {
        return paramType == MODIFIER;
    }

    /** Sets this effect parameter as a modified. */
    inline void SetModifier()
    {
        paramType = MODIFIER;
        SetDirtyFlag();
    }
    ...
    inline bool IsAnimator() const
    {
        return paramType == ANIMATOR;
    }
    ...
    inline bool IsReferencer() const
    {
        return paramType == REFERENCER;
    }

    /** Sets this effect parameter as referencer. */
    inline void SetReferencer()
    {
        paramType = REFERENCER;
        SetDirtyFlag();
    }
    ...
    inline const FCDEffectParameterAnnotation** GetAnnotations() const
    {
    ...
    inline size_t GetAnnotationCount() const
    {
    ...
    inline FCDEffectParameterAnnotation* GetAnnotation(size_t index)
    {
        FUAssert(index < GetAnnotationCount(), return NULL);
        return annotations.at(index);
    }
    inline const FCDEffectParameterAnnotation* GetAnnotation(size_t index) const
    {
        FUAssert(index < GetAnnotationCount(), return NULL);
        return annotations.at(index);
    } /**< See above. */
    ...
    inline void AddAnnotation(const fstring& name, FCDEffectParameter::Type type, const fchar* value)
    {
        AddAnnotation(name.c_str(), type, value);
    } /**< See above. */
    inline void AddAnnotation(const fchar* name, FCDEffectParameter::Type type, const fstring& value)
    {
        AddAnnotation(name, type, value.c_str());
    } /**< See above. */
    inline void AddAnnotation(const fstring& name, FCDEffectParameter::Type type, const fstring& value)
    {
        AddAnnotation(name.c_str(), type, value.c_str());
    } /**< See above. */
    template <class T>
    inline void AddAnnotation(const fchar* name, FCDEffectParameter::Type type, const T& value)
    {
        FUStringBuilder builder;
        builder.set(value);
        AddAnnotation(name, type, builder.ToCharPtr());
    } /**< See above. */
    template <class T>
    inline void AddAnnotation(const fstring& name, FCDEffectParameter::Type type, const T& value)
    {
        FUStringBuilder builder;
        builder.set(value);
        AddAnnotation(name.c_str(), type, builder.ToCharPtr());
    } /**< See above. */

    /** Releases an annotation of this parameter.
		@param annotation The annotation to release. */
    DEPRECATED(3.05A, annotation->Release)
    inline void ReleaseAnnotation(FCDEffectParameterAnnotation* annotation)
    {
        ((FCDObject*)annotation)->Release();
    }
...
public:
    ...
    inline const PrimitiveType& GetValue() const
    {
        return *value;
    }
    ...
    inline void SetValue(const PrimitiveType& _value)
    {
        value = _value;
        SetDirtyFlag();
    }
...
public:
    ...
    inline void SetFloatType(FloatType type)
    {
        floatType = type;
        SetDirtyFlag();
    }
    ...
    /** Retrieves the value of the effect parameter.
		@return The integer value. */
    inline FCDParameterAnimatableT<PrimitiveType, Qualifiers>& GetValue()
    {
        return value;
    }
    inline const FCDParameterAnimatableT<PrimitiveType, Qualifiers>& GetValue() const
    {
        return value;
    } /**< See above. */
