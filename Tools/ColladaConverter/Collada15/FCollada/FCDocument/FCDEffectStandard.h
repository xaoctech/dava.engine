...
public:
    ...
    inline LightingType GetLightingType() const
    {
        return (LightingType)*type;
    }
    ...
    inline void SetLightingType(LightingType _type)
    {
        type = _type;
        SetDirtyFlag();
    }
    ...
    {
        return FUDaeProfileType::COMMON;
    }
    ...
    inline FCDTexture** GetTextureBucket(uint32 bucket)
    {
        return const_cast<FCDTexture**>(const_cast<const FCDEffectStandard*>(this)->GetTextureBucket(bucket));
    }
    ...
    inline FCDTexture* GetTexture(uint32 bucket, size_t index)
    {
        FUAssert(index < GetTextureCount(bucket), return NULL);
        return GetTextureBucket(bucket)[index];
    }
    inline const FCDTexture* GetTexture(uint32 bucket, size_t index) const
    {
        FUAssert(index < GetTextureCount(bucket), return NULL);
        return GetTextureBucket(bucket)[index];
    } /**< See above. */
    ...
    DEPRECATED(3.05A, texture->Release())
    void ReleaseTexture(FCDTexture* texture)
    {
        ((FUObject*)texture)->Release();
    }
    ...
    inline FMVector4& GetTranslucencyColor()
    {
        return translucencyColor->GetValue();
    }
    inline const FMVector4& GetTranslucencyColor() const
    {
        return translucencyColor->GetValue();
    } /**< See above. */
    ...
    inline FCDEffectParameterColor4* GetTranslucencyColorParam()
    {
        return translucencyColor;
    }
    inline const FCDEffectParameterColor4* GetTranslucencyColorParam() const
    {
        return translucencyColor;
    } /**< See above. */
    ...
    inline void SetTranslucencyColor(const FMVector4& color)
    {
        translucencyColor->SetValue(color);
        SetDirtyFlag();
    }
    ...
    inline float& GetTranslucencyFactor()
    {
        return translucencyFactor->GetValue();
    }
    inline const float& GetTranslucencyFactor() const
    {
        return translucencyFactor->GetValue();
    } /**< See above. */
    ...
    inline FCDEffectParameterFloat* GetTranslucencyFactorParam()
    {
        return translucencyFactor;
    }
    inline const FCDEffectParameterFloat* GetTranslucencyFactorParam() const
    {
        return translucencyFactor;
    } /**< See above. */
    ...
    inline void SetTranslucencyFactor(float factor)
    {
        translucencyFactor->SetValue(factor);
        SetDirtyFlag();
    }
    ...
    inline TransparencyMode GetTransparencyMode() const
    {
        return (TransparencyMode)*transparencyMode;
    }

    /** Sets the transparency mode.
		@param mode The transparency mode. */
    inline void SetTransparencyMode(TransparencyMode mode)
    {
    ...
    inline FMVector4& GetEmissionColor()
    {
        return emissionColor->GetValue();
    }
    inline const FMVector4& GetEmissionColor() const
    {
        return emissionColor->GetValue();
    } /**< See above. */
    ...
    inline FCDEffectParameterColor4* GetEmissionColorParam()
    {
        return emissionColor;
    }
    inline const FCDEffectParameterColor4* GetEmissionColorParam() const
    {
        return emissionColor;
    } /**< See above. */
    ...
    inline void SetEmissionColor(const FMVector4& color)
    {
        emissionColor->SetValue(color);
        SetDirtyFlag();
    }
    ...
    inline float& GetEmissionFactor()
    {
        return emissionFactor->GetValue();
    }
    inline const float& GetEmissionFactor() const
    {
        return emissionFactor->GetValue();
    } /**< See above. */
    ...
    inline FCDEffectParameterFloat* GetEmissionFactorParam()
    {
        return emissionFactor;
    }
    inline const FCDEffectParameterFloat* GetEmissionFactorParam() const
    {
        return emissionFactor;
    } /**< See above. */
    ...
    inline void SetEmissionFactor(float factor)
    {
        emissionFactor->SetValue(factor);
        SetDirtyFlag();
    }
    ...
    inline bool IsEmissionFactor() const
    {
        return isEmissionFactor;
    }
    ...
    inline void SetIsEmissionFactor(bool useFactor)
    {
        isEmissionFactor = useFactor;
        SetDirtyFlag();
    }
    ...
    inline FMVector4& GetDiffuseColor()
    {
        return diffuseColor->GetValue();
    }
    inline const FMVector4& GetDiffuseColor() const
    {
        return diffuseColor->GetValue();
    } /**< See above. */
    ...
    inline FCDEffectParameterColor4* GetDiffuseColorParam()
    {
        return diffuseColor;
    }
    inline const FCDEffectParameterColor4* GetDiffuseColorParam() const
    {
        return diffuseColor;
    } /**< See above. */
    ...
    inline void SetDiffuseColor(const FMVector4& color)
    {
    ...
    inline FMVector4& GetAmbientColor()
    {
        return ambientColor->GetValue();
    }
    inline const FMVector4& GetAmbientColor() const
    {
        return ambientColor->GetValue();
    } /**< See above. */
    ...
    inline FCDEffectParameterColor4* GetAmbientColorParam()
    {
        return ambientColor;
    }
    inline const FCDEffectParameterColor4* GetAmbientColorParam() const
    {
        return ambientColor;
    } /**< See above. */
    ...
    inline void SetAmbientColor(const FMVector4& color)
    {
    ...
    inline FMVector4& GetSpecularColor()
    {
        return specularColor->GetValue();
    }
    inline const FMVector4& GetSpecularColor() const
    {
        return specularColor->GetValue();
    } /**< See above. */
    ...
    inline FCDEffectParameterColor4* GetSpecularColorParam()
    {
        return specularColor;
    }
    inline const FCDEffectParameterColor4* GetSpecularColorParam() const
    {
        return specularColor;
    } /**< See above. */
    ...
    inline void SetSpecularColor(const FMVector4& color)
    {
        specularColor->SetValue(color);
        SetDirtyFlag();
    }
    ...
    inline float& GetSpecularFactor()
    {
        return specularFactor->GetValue();
    }
    inline const float& GetSpecularFactor() const
    {
        return specularFactor->GetValue();
    } /**< See above. */
    ...
    inline FCDEffectParameterFloat* GetSpecularFactorParam()
    {
        return specularFactor;
    }
    inline const FCDEffectParameterFloat* GetSpecularFactorParam() const
    {
        return specularFactor;
    } /**< See above. */
    ...
    inline void SetSpecularFactor(float factor)
    {
        specularFactor->SetValue(factor);
        SetDirtyFlag();
    }
    ...
    inline FCDEffectParameterFloat* GetShininessParam()
    {
        return shininess;
    }
    inline const FCDEffectParameterFloat* GetShininessParam() const
    {
        return shininess;
    } /**< See above. */
    ...
    inline void SetShininess(float _shininess)
    {
        shininess->SetValue(_shininess);
        SetDirtyFlag();
    }
    ...
    inline void SetReflective(bool r)
    {
        isReflective = r;
    }
    ...
    inline FMVector4& GetReflectivityColor()
    {
        return reflectivityColor->GetValue();
    }
    inline const FMVector4& GetReflectivityColor() const
    {
        return reflectivityColor->GetValue();
    } /**< See above. */
    ...
    inline FCDEffectParameterColor4* GetReflectivityColorParam()
    {
        return reflectivityColor;
    }
    inline const FCDEffectParameterColor4* GetReflectivityColorParam() const
    {
        return reflectivityColor;
    } /**< See above. */
    ...
    inline void SetReflectivityColor(const FMVector4& color)
    {
        reflectivityColor->SetValue(color);
        isReflective = true;
        SetDirtyFlag();
    }
    ...
    inline float& GetReflectivityFactor()
    {
        return reflectivityFactor->GetValue();
    }
    inline const float& GetReflectivityFactor() const
    {
        return reflectivityFactor->GetValue();
    } /**< See above. */
    ...
    inline FCDEffectParameterFloat* GetReflectivityFactorParam()
    {
        return reflectivityFactor;
    }
    inline const FCDEffectParameterFloat* GetReflectivityFactorParam() const
    {
        return reflectivityFactor;
    } /**< See above. */
    ...
    inline void SetReflectivityFactor(float factor)
    {
        reflectivityFactor->SetValue(factor);
        isReflective = true;
        SetDirtyFlag();
    }
    ...
    inline void SetRefractive(bool r)
    {
        isRefractive = r;
    }
    ...
    inline float& GetIndexOfRefraction()
    {
        return indexOfRefraction->GetValue();
    }
    inline const float& GetIndexOfRefraction() const
    {
        return indexOfRefraction->GetValue();
    } /**< See above. */
    ...
    inline FCDEffectParameterFloat* GetIndexOfRefractionParam()
    {
        return indexOfRefraction;
    }
    inline const FCDEffectParameterFloat* GetIndexOfRefractionParam() const
    {
        return indexOfRefraction;
    } /**< See above. */
    ...
    inline void SetIndexOfRefraction(float index)
    {
        indexOfRefraction->SetValue(index);
        isRefractive = true;
        SetDirtyFlag();
    }
