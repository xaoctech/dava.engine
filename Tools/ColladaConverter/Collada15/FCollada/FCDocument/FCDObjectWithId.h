...
public:
    ...
    inline static const fm::string CleanId(const fm::string& id)
    {
        return CleanId(id.c_str());
    } /**< See above. */
    ...
    inline static const fm::string CleanSubId(const fm::string& sid)
    {
        return CleanSubId(sid.c_str());
    } /**< See above. */
};
