...
public:
    ...
    inline size_t GetPlaceHolderCount() const
    {
    ...
    inline FCDPlaceHolder* GetPlaceHolder(size_t index)
    {
        FUAssert(index < placeHolders.size(), return NULL);
        return placeHolders.at(index);
    }
    inline const FCDPlaceHolder* GetPlaceHolder(size_t index) const
    {
        FUAssert(index < placeHolders.size(), return NULL);
        return placeHolders.at(index);
    } /**< See above. */
    ...
    inline FCDPlaceHolder* FindPlaceHolder(const fstring& fileUrl)
    {
        return const_cast<FCDPlaceHolder*>(const_cast<const FCDExternalReferenceManager*>(this)->FindPlaceHolder(fileUrl));
    } /**< See above. */
    ...
    inline FCDPlaceHolder* FindPlaceHolder(FCDocument* document)
    {
        return const_cast<FCDPlaceHolder*>(const_cast<const FCDExternalReferenceManager*>(this)->FindPlaceHolder(document));
    } /**< See above. */
