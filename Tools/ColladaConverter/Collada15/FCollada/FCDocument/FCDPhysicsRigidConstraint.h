...
public:
	...
	*/
    ...
    {
        return PHYSICS_RIGID_CONSTRAINT;
    }
    ...
    inline void SetSubId(const fm::string& subId)
    {
        sid = CleanSubId(subId);
        SetDirtyFlag();
    }
    inline void SetSubId(const char* subId)
    {
        sid = CleanSubId(subId);
        SetDirtyFlag();
    } /**< See above. */
    ...
    {
        referenceRigidBody = _referenceRigidBody;
        referenceNode = NULL;
        SetNewChildFlag();
    }
    ...
    {
        interpenetrate = _interpenetrate ? 1.0f : 0.0f;
        SetDirtyFlag();
    }
    ...
    {
        limitsLinearMin = _limitsLinearMin;
        SetDirtyFlag();
    }
    ...
    {
        limitsLinearMax = _limitsLinearMax;
        SetDirtyFlag();
    }
    ...
    {
        springLinearStiffness = _springLinearStiffness;
        SetDirtyFlag();
    }
    ...
    {
        springLinearDamping = _springLinearDamping;
        SetDirtyFlag();
    }
    ...
    {
        return springLinearTargetValue;
    }
    ...
    {
        springLinearTargetValue = _springLinearTargetValue;
        SetDirtyFlag();
    }
    ...
    {
        springAngularStiffness = _springAngularStiffness;
        SetDirtyFlag();
    }
    ...
    {
        springAngularDamping = _springAngularDamping;
        SetDirtyFlag();
    }
    ...
    {
        return springAngularTargetValue;
    }
    ...
    {
        springAngularTargetValue = _springAngularTargetValue;
        SetDirtyFlag();
    }
    ...
    DEPRECATED(3.05A, GetInterpenetrate().GetAnimated)
    FCDAnimated* GetAnimatedInterpenetrate()
    {
        return GetInterpenetrate().GetAnimated();
    }
    DEPRECATED(3.05A, GetInterpenetrate().GetAnimated)
