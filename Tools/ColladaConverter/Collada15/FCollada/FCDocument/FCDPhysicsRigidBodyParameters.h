...
public:
	...
	*/
    ...
    inline void SetMassFrameTranslate(const FMVector3& position)
    {
        massFrameTranslate = position;
        parent->SetDirtyFlag();
    }

    /** Retrieves the orientation of mass of the owner.
		@return The orientation of mass. */
    inline FCDParameterAnimatableAngleAxis& GetMassFrameOrientation()
    {
        return massFrameOrientation;
    }
    inline const FCDParameterAnimatableAngleAxis& GetMassFrameOrientation() const
    {
        return massFrameOrientation;
    } /**< See above. */
    ...
    inline void SetMassFrameOrientation(const FMAngleAxis& angleAxis)
    {
        massFrameOrientation = angleAxis;
    }

    /** Retrieves the axis of orientation of mass of the owner.
		@return The axis of orientation of mass. */
    inline FMVector3& GetMassFrameRotateAxis()
    {
        return massFrameOrientation->axis;
    }
    inline const FMVector3& GetMassFrameRotateAxis() const
    {
        return massFrameOrientation->axis;
    } /**< See above. */
    ...
    inline void SetMassFrameRotateAxis(const FMVector3& axis)
    {
        massFrameOrientation->axis = axis;
        parent->SetDirtyFlag();
    }
    ...
    {
        return massFrameOrientation->angle;
    }
    ...
    inline void SetMassFrameRotateAngle(float angle)
    {
        massFrameOrientation->angle = angle;
        parent->SetDirtyFlag();
    }
    ...
    DEPRECATED(3.05A, GetPhysicsShapeCount and GetPhysicsShape(index))
    void GetPhysicsShapeList() const
    {
    }
    ...
    {
        FUAssert(index < physicsShape.size(), return NULL) return physicsShape.at(index);
    }
