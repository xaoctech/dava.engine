...
for (size_t i = 0; i < 4; ++i)
{
    ...
    {
    case 0:
        PassIf(IsEquivalent(vertex->GetPair(i)->weight, 0.22222f));
        break;
    case 1:
        PassIf(IsEquivalent(vertex->GetPair(i)->weight, 0.44444f));
        break;
    case 2:
        PassIf(IsEquivalent(vertex->GetPair(i)->weight, 0.13333f));
        break;
    case 3:
        PassIf(IsEquivalent(vertex->GetPair(i)->weight, 0.20000f));
        break;
    default:
        FUFail("");
    }
...
for (size_t i = 0; i < 2; ++i)
{
    ...
    {
    case 0:
        PassIf(IsEquivalent(vertex->GetPair(i)->weight, 1.0f / 3.0f));
        break;
    case 1:
        PassIf(IsEquivalent(vertex->GetPair(i)->weight, 2.0f / 3.0f));
        break;
    default:
        FUFail("");
    }
...
for (size_t i = 0; i < 4; ++i)
{
    ...
    {
    case 0:
        PassIf(IsEquivalent(vertex->GetPair(i)->weight, 0.11111f));
        break;
    case 1:
        PassIf(IsEquivalent(vertex->GetPair(i)->weight, 0.11111f));
        break;
    case 2:
        PassIf(IsEquivalent(vertex->GetPair(i)->weight, 0.33333f));
        break;
    case 3:
        PassIf(IsEquivalent(vertex->GetPair(i)->weight, 0.33333f));
        break;
