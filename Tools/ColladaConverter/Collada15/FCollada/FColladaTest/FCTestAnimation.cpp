...
for (size_t i = 0; i < curve1KeyCount; ++i)
{
    ...
    k->input = curve1Keys[i];
    k->output = curve1Values[i];
    k->inTangent = curve1Intan[i];
    k->outTangent = curve1Outtan[i];
}
...
for (size_t i = 0; i < curve2KeyCount; ++i)
{
    ...
    k->input = curve2Keys[i];
    k->output = curve2Values[i];
    k->inTangent = curve2Intan[i];
    k->outTangent = curve2Outtan[i];
}
