...
public:
    ...
    inline bool IsType(const FUObjectType& _type) const
    {
        return GetObjectType() == _type;
    }
    ...
    inline bool HasType(const FUObjectType& _type) const
    {
        return GetObjectType().Includes(_type);
    }
...
/**
	...
	@ingroup FUtils
*/
class FCOLLADA_EXPORT FUObjectOwner
{
protected:
    /** Owns the given object.
		@param object The object to own. */
    inline void AttachObject(FUObject* object)
    {
        object->SetObjectOwner(this);
    }
...
inline HigherClassType* DynamicCast(FUObject* object)
{
    return object->HasType(HigherClassType::GetClassType()) ? (HigherClassType*)object : NULL;
}
...
public:
    ...
    inline ObjectClass& operator*()
    {
        FUAssert(ptr != NULL, return *ptr);
        return *ptr;
    }
    inline const ObjectClass& operator*() const
    {
        FUAssert(ptr != NULL, return *ptr);
        return *ptr;
    } /**< See above. */
    ...
    inline operator const ObjectClass*() const
    {
        return ptr;
    } /**< See above. */
...
public:
    ...
    ObjectClass*& front()
    {
        return (ObjectClass*&)Parent::front();
    }
    const ObjectClass*& front() const
    {
        return (const ObjectClass*&)Parent::front();
    } /**< See above. */
    ...
    ObjectClass*& back()
    {
        return (ObjectClass*&)Parent::back();
    }
    const ObjectClass*& back() const
    {
        return (const ObjectClass*&)Parent::back();
    } /**< See above. */

    /** Retrieves an indexed object in the list.
		@param index An index.
		@return The given object. */
    inline ObjectClass* at(size_t index)
    {
        return (ObjectClass*)Parent::at(index);
    }
    inline const ObjectClass* at(size_t index) const
    {
        return (const ObjectClass*)Parent::at(index);
    } /**< See above. */
    template <class INTEGER>
    inline ObjectClass* operator[](INTEGER index)
    {
        return at(index);
    } /**< See above. */
    template <class INTEGER>
    inline const ObjectClass* operator[](INTEGER index) const
    {
        return at(index);
    } /**< See above. */
    ...
    inline iterator find(const ObjectClass* item)
    {
        return (iterator)Parent::find(item);
    }
    inline const_iterator find(const ObjectClass* item) const
    {
        return (const_iterator)Parent::find(item);
    } /**< See above. */
    ...
    /** Inserts an object in the container's containment list.
		...
		@param object An object to insert. */
    inline void insert(size_t index, ObjectClass* object)
    {
    ...
    /** Detaches a range of values from the list.
		...
		@param first The index of the first value to remove.
		@param last The index just passed the last value to remove. */
    inline void Detach(size_t first, size_t last)
    {
        Detach(begin() + first, begin() + last);
    }
    ...
    inline bool contains(const ObjectClass* value) const
    {
