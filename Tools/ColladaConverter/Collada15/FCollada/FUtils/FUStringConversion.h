...
public:
    ...
    inline static fstring ToFString(const fm::string& value)
    {
        return ToFString(value.c_str());
    } /**< See above. */
    ...
    inline static fm::string ToString(const fstring& value)
    {
    ...
    template <class CH>
    inline static bool ToBoolean(const fm::stringT<CH>& value)
    {
        return ToBoolean(value.c_str());
    } /**< See above. */
    ...
    template <class CH>
    inline static float ToFloat(const CH* value)
    {
        return ToFloat(&value);
    } /**< See above. */
    template <class CH>
    inline static float ToFloat(const fm::stringT<CH>& value)
    {
    ...
    template <class CH>
    inline static int32 ToInt32(const CH* value)
    {
        return ToInt32(&value);
    } /**< See above. */
    template <class CH>
    inline static int32 ToInt32(const fm::stringT<CH>& value)
    {
        return ToInt32(value.c_str());
    } /**< See above. */
    ...
    template <class CH>
    inline static uint32 ToUInt32(const CH* value)
    {
        return ToUInt32(&value);
    } /**< See above. */
    template <class CH>
    inline static uint32 ToUInt32(const fm::stringT<CH>& value)
    {
        return ToUInt32(value.c_str());
    } /**< See above. */
    ...
    template <class CH>
    inline static uint32 HexToUInt32(const CH* value, uint32 count = UINT_MAX)
    {
        return HexToUInt32(&value, count);
    } /**< See above. */
    template <class CH>
    inline static uint32 HexToUInt32(const fm::stringT<CH>& value, uint32 count = UINT_MAX)
    {
        return HexToUInt32(value.c_str(), count);
    } /**< See above. */
    ...
    template <class CH>
    inline static FMVector2 ToVector2(const CH* value)
    {
        return ToVector2(&value);
    } /**< See above. */
    template <class CH>
    inline static FMVector2 ToVector2(const fm::stringT<CH>& value)
    {
        return ToVector2(value.c_str());
    } /**< See above. */
    template <class CH>
    static FCOLLADA_EXPORT FMVector3 ToVector3(const CH** value); /**< See above. */
    template <class CH>
    inline static FMVector3 ToVector3(const CH* value)
    {
        return ToVector3(&value);
    } /**< See above. */
    template <class CH>
    inline static FMVector3 ToVector3(const fm::stringT<CH>& value)
    {
        return ToVector3(value.c_str());
    } /**< See above. */
    template <class CH>
    static FCOLLADA_EXPORT FMVector4 ToVector4(const CH** value); /**< See above. */
    template <class CH>
    inline static FMVector4 ToVector4(const CH* value)
    {
        return ToVector4(&value);
    } /**< See above. */
    template <class CH>
    inline static FMVector4 ToVector4(const fm::stringT<CH>& value)
    {
        return ToVector4(value.c_str());
    } /**< See above. */
    ...
    template <class CH>
    inline static void ToMatrix(const CH* value, FMMatrix44& mx)
    {
        ToMatrix(&value, mx);
    } /**< See above. */
    template <class CH>
    inline static void ToMatrix(const fm::stringT<CH>& value, FMMatrix44& mx)
    {
        ToMatrix(value.c_str(), mx);
    } /**< See above. */
    template <class CH>
    inline static FMMatrix44 ToMatrix(const CH* value)
    {
        FMMatrix44 mx;
        ToMatrix(&value, mx);
        return mx;
    ...
    template <class CH>
    inline static FMMatrix44 ToMatrix(const fm::stringT<CH>& value)
    {
        FMMatrix44 mx;
        ToMatrix(value.c_str(), mx);
        return mx;
    ...
    template <class CH>
    inline static void ToDateTime(const fm::stringT<CH>& value, FUDateTime& dateTime)
    {
        return ToDateTime(value.c_str(), dateTime);
    } /**< See above. */
...
#endif // UNICODE
    template <class CH>
    inline static void ToStringList(const fm::stringT<CH>& value, StringList& array)
    {
        return ToStringList(value.c_str(), array);
    } /**< See above. */
    ...
    template <class CH>
    inline static void ToBooleanList(const fm::stringT<CH>& value, BooleanList& array)
    {
        return ToBooleanList(value.c_str(), array);
    } /**< See above. */
    ...
    template <class CH>
    inline static void ToFloatList(const fm::stringT<CH>& value, FloatList& array)
    {
        return ToFloatList(value.c_str(), array);
    } /**< See above. */
    ...
    template <class CH>
    inline static void ToInt32List(const fm::stringT<CH>& value, Int32List& array)
    {
        return ToInt32List(value.c_str(), array);
    } /**< See above. */
    ...
    template <class CH>
    inline static void ToUInt32List(const fm::stringT<CH>& value, UInt32List& array)
    {
        return ToUInt32List(value.c_str(), array);
    } /**< See above. */
    ...
    template <class CH>
    inline static void ToInterleavedFloatList(const fm::stringT<CH>& value, fm::pvector<FloatList>& arrays)
    {
        return ToInterleavedFloatList(value.c_str(), arrays);
    } /**< See above. */
    ...
    template <class CH>
    inline static void ToInterleavedUInt32List(const fm::stringT<CH>& value, fm::pvector<UInt32List>& arrays)
    {
        return ToInterleavedFloatList(value.c_str(), arrays);
    } /**< See above. */
    ...
    template <class CH>
    inline static void ToMatrixList(const fm::stringT<CH>& value, FMMatrix44List& array)
    {
        return ToMatrixList(value.c_str(), array);
    } /**< See above. */
    ...
    template <class CH>
    inline static void ToVector2List(const fm::stringT<CH>& value, FMVector2List& array)
    {
        return ToVector2List(value.c_str(), array);
    } /**< See above. */
    ...
    template <class CH>
    inline static void ToVector3List(const fm::stringT<CH>& value, FMVector3List& array)
    {
        return ToVector3List(value.c_str(), array);
    } /**< See above. */
    ...
    template <class CH>
    inline static void ToPointList(const CH* value, FMVector3List& array)
    {
        return ToVector3List(value, array);
    }
    template <class CH>
    inline static void ToPointList(const fm::stringT<CH>& value, FMVector3List& array)
    {
        return ToVector3List(value.c_str(), array);
    } /**< See above. */
    ...
    template <class CH>
    inline static void ToVector4List(const fm::stringT<CH>& value, FMVector4List& array)
    {
        return ToVector4List(value.c_str(), array);
    } /**< See above. */
    ...
    {
        return ToString(builder, values.begin(), values.size());
    }
    ...
    static inline int32 ParseQualifier(const fm::string& string)
    {
        return ParseQualifier(string.c_str());
    }
