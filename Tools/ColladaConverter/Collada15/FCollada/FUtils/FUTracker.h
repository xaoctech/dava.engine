...
public:
    ...
    {
        return object != NULL ? object->HasTracker(this) : false;
    }
...
public:
    ...
    {
        if (ptr != NULL)
            FUTracker::UntrackObject((FUTrackable*)ptr);
        ptr = NULL;
    }
    ...
    inline FUTrackedPtr& operator=(const FUTrackedPtr& _ptr)
    {
        return operator=(_ptr.ptr);
    } /**< See above. */
...
public:
    ...
    virtual bool TracksObject(const FUTrackable* object) const
    {
        return Parent::contains((ObjectClass*)object);
    }
