...
void ConsoleDockWidget::Output( DAVA::Logger::eLogLevel ll, const DAVA::char8* text ) const
{
    Output(ll, QString(text));
}

void ConsoleDockWidget::Output( DAVA::Logger::eLogLevel ll, const DAVA::char16* text ) const
{
