...
const FastName Settings::General_LodEditor_MinEdge = FastName("General/LodEditor/Minimum edge");
const FastName Settings::General_LodEditor_MaxEdge = FastName("General/LodEditor/Maximum edge");
const FastName Settings::General_LodEditor_Recursive = FastName("General/LodEditor/Recursive");
