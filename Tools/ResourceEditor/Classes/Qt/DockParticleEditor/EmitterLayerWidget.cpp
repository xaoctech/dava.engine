...
void EmitterLayerWidget::OnValueChanged()
{
    ...
    auto updateLayerCmd = DAVA::Command::Create<CommandUpdateParticleLayer>(GetEmitterInstance(activeScene), layer);
...
void EmitterLayerWidget::OnLayerMaterialValueChanged()
{
    ...
    DVASSERT(GetActiveScene() != nullptr);
    GetActiveScene()->Exec(DAVA::Command::Create<CommandChangeLayerMaterialProperties>(layer, spritePath, blending, fogCheckBox->isChecked(), frameBlendingCheckBox->isChecked()));
...
void EmitterLayerWidget::OnLodsChanged()
{
    ...
    GetActiveScene()->Exec(DAVA::Command::Create<CommandUpdateParticleLayerLods>(layer, lods));
    GetActiveScene()->MarkAsChanged();
    emit ValueChanged();
}
