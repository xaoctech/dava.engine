    ...
    : QStyledItemDelegate(parent)
{
    ...
    anyItemDelegates[Type::Instance<VarTable>()] = new VarTablePropertyDelegate(this);
    ...
    propertyNameTypeItemDelegates[PropertyPath("UIVisualScriptComponent", "scriptPath")] = new ResourceFilePropertyDelegate(visualScriptExtensions, "/VisualScript/", this, true);
}
