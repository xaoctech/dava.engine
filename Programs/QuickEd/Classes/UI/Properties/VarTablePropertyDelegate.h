...
class QAction;
class VarTablePropertyDelegate : public BasePropertyDelegate
{
    Q_OBJECT
public:
    explicit VarTablePropertyDelegate(PropertiesTreeItemDelegate* delegate);
    ~VarTablePropertyDelegate();
