...
private:
    ...
    virtual bool CanProcessInput(DAVA::UIEvent* currentInput, bool generated = false) const;
    //process input to realize state logic.  Generated indicates that input is generated by canvas
    virtual void ProcessInput(DAVA::UIEvent* currentInput, bool generated = false);
