...
{
public:
    LocalizedTextValueProperty(DAVA::BaseObject* object, const DAVA::ReflectedStructure::Field* Field, const IntrospectionProperty* sourceProperty, eCloneType cloneType);
