...
public:
	...
	*/
    ...
    virtual bool IsPartialExportSupported()
    {
        return true;
    }

    virtual bool IsExtensionSupported(const char* ext);
    virtual int GetSupportedExtensionsCount()
    {
        return NUM_EXTENSIONS + (int)extraExtensions.size();
    }
	...
	*/
    ...
    {
        return FCP_ARCHIVECOLLADA_NAME;
    }
    virtual uint32 GetPluginVersion() const
    {
        return 1;
    }
...
public:
	...
	*/
    ...
    //
    template <class T>
    static bool LoadLibrary(FCDObject* object, xmlNode* node);
