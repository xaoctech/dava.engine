...
inline fm::string ReadNodeId(xmlNode* node)
{
    return ReadNodeProperty(node, DAE_ID_ATTRIBUTE);
}
inline fm::string ReadNodeSid(xmlNode* node)
{
    return ReadNodeProperty(node, DAE_SID_ATTRIBUTE);
}
inline fm::string ReadNodeSemantic(xmlNode* node)
{
    return ReadNodeProperty(node, DAE_SEMANTIC_ATTRIBUTE);
}
inline fm::string ReadNodeName(xmlNode* node)
{
    return ReadNodeProperty(node, DAE_NAME_ATTRIBUTE);
}
inline fm::string ReadNodeSource(xmlNode* node)
{
    return ReadNodeProperty(node, DAE_SOURCE_ATTRIBUTE);
}
inline fm::string ReadNodeStage(xmlNode* node)
{
    return ReadNodeProperty(node, DAE_STAGE_ATTRIBUTE);
}
