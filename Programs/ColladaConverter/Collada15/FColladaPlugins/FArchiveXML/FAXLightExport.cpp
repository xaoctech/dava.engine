...
xmlNode* FArchiveXML::WriteLight(FCDObject* object, xmlNode* parentNode)
{
    ...
    {
    case FCDLight::POINT:
        baseNodeName = DAE_LIGHT_POINT_ELEMENT;
        break;
    case FCDLight::SPOT:
        baseNodeName = DAE_LIGHT_SPOT_ELEMENT;
        break;
    case FCDLight::AMBIENT:
        baseNodeName = DAE_LIGHT_AMBIENT_ELEMENT;
        break;
    case FCDLight::DIRECTIONAL:
        baseNodeName = DAE_LIGHT_DIRECTIONAL_ELEMENT;
        break;
    default:
        baseNodeName = DAEERR_UNKNOWN_INPUT;
        break;
    }
