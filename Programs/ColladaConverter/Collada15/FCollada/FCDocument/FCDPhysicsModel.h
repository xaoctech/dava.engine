...
public:
	...
	*/
    ...
    {
        return FCDEntity::PHYSICS_MODEL;
    }
    ...
    {
        FUAssert(index < rigidBodies.size(), return NULL);
    ...
    /** Retrieves a specific rigid body that is a part of this physics model
		...
		@return The rigid body. */
    inline FCDPhysicsRigidBody* FindRigidBodyFromSid(const fm::string& sid)
    {
    ...
    {
        FUAssert(index < GetRigidConstraintCount(), return NULL);
        return rigidConstraints.at(index);
    }
    ...
    /** Retrieves a specific rigid constraint that is a part of tihs physics
		...
		@return The rigid constraint. */
    inline FCDPhysicsRigidConstraint* FindRigidConstraintFromSid(const fm::string& sid)
    {
