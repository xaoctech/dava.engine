...
public:
    ...
    {
        return FCDEntityInstance::PHYSICS_MODEL;
    }

    /** Retrieves all the instances from this physics model instance.
		@return The instances. */
    DEPRECATED(3.05A, GetInstanceCount and GetInstance(index))
    void GetInstances() const
    {
    }
    ...
    {
        FUAssert(index < GetInstanceCount(), return NULL);
    ...
    DEPRECATED(3.05A, instance->Release() or SAFE_RELEASE(instance))
    bool RemoveInstance(FCDEntityInstance* instance);
