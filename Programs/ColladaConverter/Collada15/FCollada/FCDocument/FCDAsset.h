...
public:
    ...
    inline const FCDAssetContributor** GetContributors() const
    {
    ...
    inline size_t GetContributorCount() const
    {
    ...
    inline FCDAssetContributor* GetContributor(size_t index)
    {
        FUAssert(index < GetContributorCount(), return NULL);
        return contributors.at(index);
    }
    inline const FCDAssetContributor* GetContributor(size_t index) const
    {
        FUAssert(index < GetContributorCount(), return NULL);
        return contributors.at(index);
    } /**< See above. */
    ...
    inline const FUDateTime& GetCreationDateTime() const
    {
    ...
    /** [INTERNAL] Use this function to createDateTime when you are writing an import plug-in.	
		see above */
    inline FUDateTime& GetCreationDateTime()
    {
        return creationDateTime;
    }
    ...
    /** Retrieves the last modification date-time of the document.
		...
		@return The date-time at which the COLLADA document
			was last modified. */
    inline const FUDateTime& GetModifiedDateTime() const
    {
    ...
    /** [INTERNAL] Use this function to retieve the modifiedDateTime when you are writing an 
					import plug-in.	
		see above */
    inline FUDateTime& GetModifiedDateTime()
    {
        return modifiedDateTime;
    }
    ...
    inline const fstring& GetKeywords() const
    {
        return keywords;
    }
    ...
    inline void SetKeywords(const fstring& _keywords)
    {
        keywords = _keywords;
        SetDirtyFlag();
    }
    ...
    inline void SetRevision(const fstring& _revision)
    {
        revision = _revision;
        SetDirtyFlag();
    }
    ...
    inline const fstring& GetSubject() const
    {
        return subject;
    }
    ...
    inline void SetSubject(const fstring& _subject)
    {
        subject = _subject;
        SetDirtyFlag();
    }
    ...
    inline void SetTitle(const fstring& _title)
    {
        title = _title;
        SetDirtyFlag();
    }
    ...
    inline const FMVector3& GetUpAxis() const
    {
        return upAxis;
    }
    ...
    inline void SetUpAxis(const FMVector3& _upAxis)
    {
        upAxis = _upAxis;
        SetHasUpAxisFlag();
        SetDirtyFlag();
    ...
    inline const fstring& GetUnitName() const
    {
        return unitName;
    }
    ...
    inline void SetUnitName(const fstring& _unitName)
    {
        unitName = _unitName;
        SetDirtyFlag();
    }
    ...
    inline float GetUnitConversionFactor() const
    {
    ...
    inline void SetUnitConversionFactor(float factor)
    {
    ...
    DEPRECATED(3.05A, GetHasUpAxisFlag)
    inline bool HasUpAxis() const
    {
        return GetHasUpAxisFlag();
    }
    ...
    DEPRECATED(3.05A, GetHasUnitsFlag)
    inline bool HasUnits() const
    {
        return GetHasUnitsFlag();
    }

    /** Resets the up-axis of the asset.
		The parent asset up-axis should henceforth be used.
		Changing the up-axis of an asset does not modify its data. */
    DEPRECATED(3.05A, ResetHasUpAxisFlag)
    inline void ResetUpAxis()
    {
        ResetHasUpAxisFlag();
    }
    ...
    DEPRECATED(3.05A, ResetHasUnitsFlag)
    inline void ResetUnits()
    {
        ResetHasUnitsFlag();
    }
...
public:
    ...
    inline const fstring& GetAuthor() const
    {
        return author;
    }
    ...
    inline void SetAuthor(const fstring& _author)
    {
        author = _author;
        SetDirtyFlag();
    }
    ...
    inline const fstring& GetAuthoringTool() const
    {
    ...
    inline void SetAuthoringTool(const fstring& _authoringTool)
    {
    ...
    inline const fstring& GetComments() const
    {
        return comments;
    }
    ...
    inline void SetComments(const fstring& _comments)
    {
        comments = _comments;
        SetDirtyFlag();
    }
    ...
    inline const fstring& GetCopyright() const
    {
        return copyright;
    }
    ...
    inline const fstring& GetSourceData() const
    {
        return sourceData;
    }
    ...
    inline void SetSourceData(const fstring& _sourceData)
    {
