...
public:
    ...
    /** Retrieves the skin controller.
		...
		@return The skin controller. This pointer will be NULL, if the controller
			is not a skin. */
    inline FCDSkinController* GetSkinController()
    {
        return skinController;
    }
    inline const FCDSkinController* GetSkinController() const
    {
        return skinController;
    } /**< See above. */
    ...
    /** Retrieves the morph controller.
		...
		@return The morph controller. This pointer will be NULL, if the controller
			is not a morpher. */
    inline FCDMorphController* GetMorphController()
    {
        return morphController;
    }
    inline const FCDMorphController* GetMorphController() const
    {
        return morphController;
    } /**< See above. */
    ...
    /** Retrieves the base target geometry for this controller.
		...
		@return The base target geometry. This pointer will be NULL
			...
			is not a geometry. */
    inline FCDGeometry* GetBaseGeometry()
    {
        return const_cast<FCDGeometry*>(const_cast<const FCDController*>(this)->GetBaseGeometry());
    }
    ...
    /** Retrieves the lowest controller on this stack.
		...
		@return The base controller. This pointer will be NULL
			if no base target is defined or if the base target entity
			is not a geometry. */
    inline FCDController* GetBaseGeometryController()
    {
        return const_cast<FCDController*>(const_cast<const FCDController*>(this)->GetBaseGeometryController());
    }
