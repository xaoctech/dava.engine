...
public:
    ...
    inline const TYPE& operator[](INTEGER index) const
    {
        return values[index];
    } /**< See above. */
    ...
    {
        return values.find(value) - values.begin();
    }
    ...
    {
        return values.GetDataPtr();
    }
    inline const TYPE** GetDataPtr() const
    {
        return values.GetDataPtr();
    } /**< See above. */
    ...
    inline fm::vector<TYPE, true>& GetDataList()
    {
        return values;
    }
    inline const fm::vector<TYPE, true>& GetDataList() const
    {
        return values;
    } /**< See above. */
