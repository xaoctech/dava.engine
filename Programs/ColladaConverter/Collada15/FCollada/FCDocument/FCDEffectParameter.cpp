...
template <>
FCDEffectParameter::Type FCDEffectParameterInt::GetType() const
{
    return FCDEffectParameter::INTEGER;
}
template <>
FCDEffectParameter::Type FCDEffectParameterString::GetType() const
{
    return FCDEffectParameter::STRING;
}
template <>
FCDEffectParameter::Type FCDEffectParameterBool::GetType() const
{
    return FCDEffectParameter::BOOLEAN;
}

template <>
FCDEffectParameterInt::FCDEffectParameterT(FCDocument* document)
    : FCDEffectParameter(document)
    , InitializeParameter(value, 0)
{
}
template <>
FCDEffectParameterString::FCDEffectParameterT(FCDocument* document)
    : FCDEffectParameter(document)
    , InitializeParameterNoArg(value)
{
}
template <>
FCDEffectParameterBool::FCDEffectParameterT(FCDocument* document)
    : FCDEffectParameter(document)
    , InitializeParameter(value, false)
{
}
...
template <>
FCDEffectParameter::Type FCDEffectParameterFloat::GetType() const
{
    return FCDEffectParameter::FLOAT;
}
template <>
FCDEffectParameter::Type FCDEffectParameterFloat2::GetType() const
{
    return FCDEffectParameter::FLOAT2;
}
template <>
FCDEffectParameter::Type FCDEffectParameterFloat3::GetType() const
{
    return FCDEffectParameter::FLOAT3;
}
template <>
FCDEffectParameter::Type FCDEffectParameterColor3::GetType() const
{
    return FCDEffectParameter::FLOAT3;
}
template <>
FCDEffectParameter::Type FCDEffectParameterVector::GetType() const
{
    return FCDEffectParameter::VECTOR;
}
template <>
FCDEffectParameter::Type FCDEffectParameterColor4::GetType() const
{
    return FCDEffectParameter::VECTOR;
}
template <>
FCDEffectParameter::Type FCDEffectParameterMatrix::GetType() const
{
    return FCDEffectParameter::MATRIX;
}

template <>
FCDEffectParameterFloat::FCDEffectParameterAnimatableT(FCDocument* document)
    : FCDEffectParameter(document)
    , floatType(FLOAT)
    , InitializeParameterAnimatable(value, 0.0f)
{
}
template <>
FCDEffectParameterFloat2::FCDEffectParameterAnimatableT(FCDocument* document)
    : FCDEffectParameter(document)
    , floatType(FLOAT)
    , InitializeParameterAnimatable(value, FMVector2::Zero)
{
}
template <>
FCDEffectParameterFloat3::FCDEffectParameterAnimatableT(FCDocument* document)
    : FCDEffectParameter(document)
    , floatType(FLOAT)
    , InitializeParameterAnimatable(value, FMVector3::Zero)
{
}
template <>
FCDEffectParameterColor3::FCDEffectParameterAnimatableT(FCDocument* document)
    : FCDEffectParameter(document)
    , floatType(FLOAT)
    , InitializeParameterAnimatable(value, FMVector3::One)
{
}
template <>
FCDEffectParameterVector::FCDEffectParameterAnimatableT(FCDocument* document)
    : FCDEffectParameter(document)
    , floatType(FLOAT)
    , InitializeParameterAnimatable(value, FMVector4::Zero)
{
}
template <>
FCDEffectParameterColor4::FCDEffectParameterAnimatableT(FCDocument* document)
    : FCDEffectParameter(document)
    , floatType(FLOAT)
    , InitializeParameterAnimatable(value, FMVector4::One)
{
}
template <>
FCDEffectParameterMatrix::FCDEffectParameterAnimatableT(FCDocument* document)
    : FCDEffectParameter(document)
    , floatType(FLOAT)
    , InitializeParameterAnimatable(value, FMMatrix44::Identity)
{
}
...
template <class T>
void TrickLinkerEffectParameterT()
{
...
void TrickLinkerEffectParameterAnimatableT()
{
    static bool toBe = false;
