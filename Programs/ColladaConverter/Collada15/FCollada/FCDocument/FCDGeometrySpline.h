...
public:
    ...
    {
        return form == FUDaeSplineForm::CLOSED;
    }
    ...
    {
        form = (closed) ? FUDaeSplineForm::CLOSED : FUDaeSplineForm::OPEN;
    }

    /** Retrieves the number of CVs in the spline.
		@return The number of control vertices.*/
    inline size_t GetCVCount() const
    {
        return cvs.size();
    }
    ...
    inline FMVector3* GetCV(size_t index)
    {
        FUAssert(index < GetCVCount(), return NULL);
        return &(cvs.at(index));
    }
    inline const FMVector3* GetCV(size_t index) const
    {
        FUAssert(index < GetCVCount(), return NULL);
        return &(cvs.at(index));
    } /**< See above. */
    ...
    inline FMVector3List& GetCVs()
    {
        return cvs;
    }
    inline const FMVector3List& GetCVs() const
    {
        return cvs;
    } /**< See above. */

    /** Empty the spline's control vertex list. */
    inline void ClearCVs()
    {
        cvs.clear();
    }
...
public:
    ...
    inline void SetDegree(uint32 deg)
    {
        degree = deg;
    }
    ...
    inline float* GetWeight(size_t index)
    {
        FUAssert(index < GetCVCount(), return NULL);
        return &(weights.at(index));
    }
    inline const float* GetWeight(size_t index) const
    {
        FUAssert(index < GetCVCount(), return NULL);
        return &(weights.at(index));
    } /**< See above. */
    ...
    inline size_t GetKnotCount() const
    {
        return knots.size();
    }
    ...
    inline float* GetKnot(size_t index)
    {
        FUAssert(index < GetKnotCount(), return NULL);
        return &(knots.at(index));
    }
    inline const float* GetKnot(size_t index) const
    {
        FUAssert(index < GetKnotCount(), return NULL);
        return &(knots.at(index));
    } /**< See above. */
    ...
    inline FloatList& GetWeights()
    {
        return weights;
    }
    inline const FloatList& GetWeights() const
    {
        return weights;
    } /**< See above. */
    ...
    inline FloatList& GetKnots()
    {
        return knots;
    }
    inline const FloatList& GetKnots() const
    {
        return knots;
    } /**< See above. */
...
public:
    ...
    {
        return (FUDaeSplineType::Type)*type;
    }
    ...
    {
        FUAssert(index < GetSplineCount(), return NULL);
