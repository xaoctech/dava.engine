...
public:
    ...
    inline FCDAnimationChannel* GetParent()
    {
        return parent;
    }
    inline const FCDAnimationChannel* GetParent() const
    {
        return parent;
    } /**< See above. */
    ...
    inline FCDAnimationKey** GetKeys()
    {
        return keys.begin();
    }
    inline const FCDAnimationKey** GetKeys() const
    {
        return keys.begin();
    } /**< See above. */
    ...
    inline size_t GetKeyCount() const
    {
        return keys.size();
    }
    ...
    /** Retrieves one key in the animation curve.
		...
		@return The key. */
    inline FCDAnimationKey* GetKey(size_t index)
    {
        FUAssert(index < keys.size(), return NULL);
        return keys.at(index);
    }
    inline const FCDAnimationKey* GetKey(size_t index) const
    {
        FUAssert(index < keys.size(), return NULL);
        return keys.at(index);
    } /**< See above. */
    ...
    {
        size_t blah;
        return AddKey(interpolation, input, blah);
    }
    ...
    inline FUDaeInfinity::Infinity GetPreInfinity() const
    {
        return preInfinity;
    }
    ...
    inline void SetPreInfinity(FUDaeInfinity::Infinity infinity)
    {
        preInfinity = infinity;
        SetDirtyFlag();
    }
    ...
    inline FUDaeInfinity::Infinity GetPostInfinity() const
    {
        return postInfinity;
    }
    ...
    inline void SetPostInfinity(FUDaeInfinity::Infinity infinity)
    {
        postInfinity = infinity;
        SetDirtyFlag();
    }
	...
	*/
    ...
    inline size_t GetClipCount() const
    {
        return clips.size();
    }
    ...
    inline FCDAnimationClip** GetClips()
    {
        return clips.begin();
    }
    inline const FCDAnimationClip** GetClips() const
    {
        return clips.begin();
    } /**< See above. */
    ...
    inline FCDAnimationClip* GetClip(size_t index)
    {
        FUAssert(index < clips.size(), return NULL);
        return clips[index];
    }
    inline const FCDAnimationClip* GetClip(size_t index) const
    {
        FUAssert(index < clips.size(), return NULL);
        return clips[index];
    } /**< See above. */
    ...
    inline const float GetClipOffset(size_t index) const
    {
        return clipOffsets.at(index);
    }
    ...
    inline int32 GetTargetElement() const
    {
    ...
    inline const fm::string& GetTargetQualifier() const
    {
    ...
    inline void SetTargetElement(int32 e)
    {
        targetElement = e;
        SetDirtyFlag();
    }
    ...
    inline void SetTargetQualifier(const fm::string& q)
    {
        targetQualifier = q;
        SetDirtyFlag();
    }
...
{
public:
    FCDConversionFunctor()
    {
    } /**< Constructor. */
    virtual ~FCDConversionFunctor()
    {
    } /**< Destructor. */
...
public:
    FCDConversionScaleFunctor(float factor)
    {
        scaleFactor = factor;
    ...
    virtual ~FCDConversionScaleFunctor()
    {
    } /**< Destructor. */
    ...
    virtual FMVector3 operator()(const FMVector3& v)
    {
        return v * scaleFactor;
    } /**< Scales the given FMVector3. @param v The value to scale. @return The scaled value. */
    virtual FMVector4 operator()(const FMVector4& v)
    {
        return v * scaleFactor;
    } /**< Scales the given FMVector4. @param v The value to scale. @return The scaled value. */
};
