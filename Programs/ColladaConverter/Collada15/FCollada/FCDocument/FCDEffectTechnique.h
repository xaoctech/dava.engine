...
public:
    ...
    inline FCDEffectProfileFX* GetParent()
    {
        return parent;
    }
    inline const FCDEffectProfileFX* GetParent() const
    {
        return parent;
    } /**< See above. */
    ...
    DEPRECATED(3.05A, GetParent()->GetParent()->GetDaeId)
    ...
    DEPRECATED(3.05A, GetPassCount and GetPass(index))
    void GetPassList()
    {
    }
    ...
    {
        FUAssert(index < GetPassCount(), return NULL);
    ...
    DEPRECATED(3.05A, GetCodeCount and GetCode(index) or FindCode)
    void GetCodeList()
    {
    }
    ...
    {
        return const_cast<FCDEffectCode*>(const_cast<const FCDEffectTechnique*>(this)->FindCode(sid));
    }
