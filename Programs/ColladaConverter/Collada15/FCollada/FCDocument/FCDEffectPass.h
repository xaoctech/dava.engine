...
public:
    ...
    inline FCDEffectTechnique* GetParent()
    {
        return parent;
    }
    inline const FCDEffectTechnique* GetParent() const
    {
        return parent;
    } /**< See above. */
    ...
    DEPRECATED(3.05A, GetParent()->GetParent()->GetParent()->GetDaeId())
    ...
    /** Retrieves the sub-id of the effect pass.
		...
		@return The sub-id. */
    inline const fstring& GetPassName() const
    {
        return name;
    }
    ...
    inline void SetPassName(const fchar* _name)
    {
        name = _name;
        SetDirtyFlag();
    }
    ...
    inline size_t GetShaderCount() const
    {
        return shaders.size();
    }
    ...
    inline FCDEffectPassShader* GetShader(size_t index)
    {
        FUAssert(index < GetShaderCount(), return NULL);
        return shaders.at(index);
    }
    inline const FCDEffectPassShader* GetShader(size_t index) const
    {
        FUAssert(index < GetShaderCount(), return NULL);
        return shaders.at(index);
    } /**< See above. */
    ...
    DEPRECATED(3.05A, shader->Release())
    void ReleaseShader(FCDEffectPassShader* shader)
    {
        ((FCDObject*)shader)->Release();
    }
    ...
    inline FCDEffectPassShader* GetVertexShader()
    {
        return const_cast<FCDEffectPassShader*>(const_cast<const FCDEffectPass*>(this)->GetVertexShader());
    }
    ...
    inline FCDEffectPassShader* GetFragmentShader()
    {
        return const_cast<FCDEffectPassShader*>(const_cast<const FCDEffectPass*>(this)->GetFragmentShader());
    }
    ...
    DEPRECATED(3.05A, GetRenderStateCount and GetRenderState(index))
    void GetRenderStates() const
    {
    }

    /** Retrieves the number of render states defined for the pass.
		@return The render state count. */
    inline size_t GetRenderStateCount() const
    {
        return states.size();
    }
    ...
    inline FCDEffectPassState* GetRenderState(size_t index)
    {
        FUAssert(index < states.size(), return NULL);
        return states.at(index);
    }
    inline const FCDEffectPassState* GetRenderState(size_t index) const
    {
        FUAssert(index < states.size(), return NULL);
        return states.at(index);
    } /**< See above. */
    ...
    inline FCDEffectPassState* FindRenderState(FUDaePassState::State type)
    {
        return const_cast<FCDEffectPassState*>(const_cast<const FCDEffectPass*>(this)->FindRenderState(type));
    }
