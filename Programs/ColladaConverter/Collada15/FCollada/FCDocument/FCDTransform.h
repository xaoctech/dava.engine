...
public:
    ...
    /** Retrieves the wanted sub-id for this transform.
		...
		@return The sub-id. */
    inline FUParameterString& GetSubId()
    {
        return sid;
    }
    inline const FUParameterString& GetSubId() const
    {
        return sid;
    } /**< See above. */
    ...
    /** Retrieves the animated element for the transformation.
		@return The animated element. This pointer will be NULL if the transformation
			is not animated. */
    inline FCDAnimated* GetAnimated()
    {
        return const_cast<FCDAnimated*>(const_cast<const FCDTransform*>(this)->GetAnimated());
    }
...
public:
    ...
    inline FCDParameterAnimatableVector3& GetTranslation()
    {
        return translation;
    }
    inline const FCDParameterAnimatableVector3& GetTranslation() const
    {
        return translation;
    } /**< See above. */
    ...
    inline void SetTranslation(const FMVector3& _translation)
    {
...
public:
    ...
    inline FCDParameterAnimatableVector3& GetScale()
    {
        return scale;
    }
    inline const FCDParameterAnimatableVector3& GetScale() const
    {
        return scale;
    } /**< See above. */
    ...
    inline void SetScale(const FMVector3& _scale)
    {
        scale = _scale;
        SetValueChange();
    }
...
public:
    ...
    inline FCDParameterAnimatableAngleAxis& GetAngleAxis()
    {
        return angleAxis;
    }
    inline const FCDParameterAnimatableAngleAxis& GetAngleAxis() const
    {
        return angleAxis;
    } /**< See above. */
    ...
    inline void SetAngleAxis(const FMAngleAxis& aa)
    {
        angleAxis = aa;
        SetValueChange();
    }
    ...
    inline FMVector3& GetAxis()
    {
        return angleAxis->axis;
    }
    inline const FMVector3& GetAxis() const
    {
        return angleAxis->axis;
    } /**< See above. */
    ...
    inline void SetAxis(const FMVector3& axis)
    {
        angleAxis->axis = axis;
        SetValueChange();
    }
    ...
    {
        angleAxis->axis = FMVector3(x, y, z);
        SetValueChange();
    }
    ...
    inline void SetRotation(const FMVector3& axis, float angle)
    {
        angleAxis = FMAngleAxis(axis, angle);
        SetValueChange();
    }

    /** Retrieves the rotation orientation.
		@return The rotation orientation quaternion. */
    inline FMQuaternion GetOrientation()
    {
        return FMQuaternion(angleAxis->axis, FMath::DegToRad(angleAxis->angle));
    }

    /** Sets the rotation orientation.
		@param q The rotation orientation quaternion. */
    inline void SetOrientation(const FMQuaternion& q)
    {
        q.ToAngleAxis(angleAxis->axis, angleAxis->angle);
        angleAxis->angle = FMath::RadToDeg(angleAxis->angle);
        SetValueChange();
    }
...
public:
    ...
    inline FCDParameterAnimatableMatrix44& GetTransform()
    {
        return transform;
    }
    inline const FCDParameterAnimatableMatrix44& GetTransform() const
    {
        return transform;
    } /**< See above. */
    ...
    inline void SetTransform(const FMMatrix44& mx)
    {
        transform = mx;
        SetValueChange();
    }
...
public:
    ...
    inline FCDParameterAnimatableLookAt& GetLookAt()
    {
        return lookAt;
    }
    inline const FCDParameterAnimatableLookAt& GetLookAt() const
    {
        return lookAt;
    } /**< See above. */
    ...
    inline void SetLookAt(const FMLookAt& _lookAt)
    {
        lookAt = _lookAt;
        SetValueChange();
    }
    ...
    inline void SetPosition(const FMVector3& pos)
    {
        lookAt->position = pos;
        SetValueChange();
    }
    ...
    {
        lookAt->position = FMVector3(x, y, z);
        SetValueChange();
    }
    ...
    inline void SetTarget(const FMVector3& target)
    {
    ...
    inline void SetUp(const FMVector3& up)
    {
        lookAt->up = up;
        SetValueChange();
    }
...
public:
    ...
    inline FCDParameterAnimatableSkew& GetSkew()
    {
        return skew;
    }
    inline const FCDParameterAnimatableSkew& GetSkew() const
    {
        return skew;
    }
    ...
    inline void SetSkew(const FMSkew& _skew)
    {
        skew = _skew;
        SetValueChange();
    }
    ...
    inline void SetRotateAxis(const FMVector3& axis)
    {
        skew->rotateAxis = axis;
        SetValueChange();
    }

    /** Retrieves the axis around which the rotation is done.
		@return The rotation axis. */
    inline const FMVector3& GetAroundAxis() const
    {
        return skew->aroundAxis;
    }
    inline FMVector3& GetAroundAxis()
    {
        return skew->aroundAxis;
    } /**< See above. */
    ...
    /** Sets the axis around which the rotation is done.
		@param axis The rotation axis. */
    inline void SetAroundAxis(const FMVector3& axis)
    {
        skew->aroundAxis = axis;
        SetValueChange();
    }
