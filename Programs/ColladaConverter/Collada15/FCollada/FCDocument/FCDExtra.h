...
public:
    ...
    inline FUObject* GetParent()
    {
        return parent;
    }
    inline const FUObject* GetParent() const
    {
        return parent;
    } /**< See above. */
    ...
    DEPRECATED(3.05A, GetTypeCount and GetType(index))
    inline void GetTypes() const
    {
    }
    ...
    inline FCDEType* GetDefaultType()
    {
        return const_cast<FCDEType*>(const_cast<const FCDExtra*>(this)->GetDefaultType());
    }
    inline const FCDEType* GetDefaultType() const
    {
        return FindType("");
    } /**< See above. */
    ...
    inline FCDEType* GetType(size_t index)
    {
        FUAssert(index < types.size(), return NULL);
        return types.at(index);
    }
    inline const FCDEType* GetType(size_t index) const
    {
        FUAssert(index < types.size(), return NULL);
        return types.at(index);
    } /**< See above. */
    ...
    inline FCDEType* AddType(const fm::string& name)
    {
        return AddType(name.c_str());
    } /**< See above. */
    ...
    inline FCDEType* FindType(const char* name)
    {
        return const_cast<FCDEType*>(const_cast<const FCDExtra*>(this)->FindType(name));
    }
    const FCDEType* FindType(const char* name) const; /**< See above. */
    inline FCDEType* FindType(const fm::string& name)
    {
        return FindType(name.c_str());
    } /**< See above. */
    inline const FCDEType* FindType(const fm::string& name) const
    {
        return FindType(name.c_str());
    } /**< See above. */
...
public:
    ...
    inline FCDExtra* GetParent()
    {
        return parent;
    }
    inline const FCDExtra* GetParent() const
    {
        return parent;
    } /**< See above. */
    ...
    inline const fm::string& GetName() const
    {
        return name;
    }
    ...
    inline void SetName(const fm::string& _name)
    {
        name = _name;
    }
    ...
    inline FCDETechnique* GetTechnique(size_t index)
    {
        FUAssert(index < techniques.size(), return NULL);
        return techniques.at(index);
    }
    inline const FCDETechnique* GetTechnique(size_t index) const
    {
        FUAssert(index < techniques.size(), return NULL);
        return techniques.at(index);
    } /**< See above. */
    ...
    inline FCDETechnique* AddTechnique(const fm::string& profile)
    {
        return AddTechnique(profile.c_str());
    } /**< See above. */
    ...
    {
        return const_cast<FCDETechnique*>(const_cast<const FCDEType*>(this)->FindTechnique(profile));
    }
    const FCDETechnique* FindTechnique(const char* profile) const; /**< See above. */
    inline FCDETechnique* FindTechnique(const fm::string& profile)
    {
        return FindTechnique(profile.c_str());
    } /**< See above. */
    inline const FCDETechnique* FindTechnique(const fm::string& profile) const
    {
        return FindTechnique(profile.c_str());
    } /**< See above. */
    ...
    inline FCDENode* FindRootNode(const char* name)
    {
        return const_cast<FCDENode*>(const_cast<const FCDEType*>(this)->FindRootNode(name));
    }
    const FCDENode* FindRootNode(const char* name) const; /**< See above. */
    inline FCDENode* FindRootNode(const fm::string& name)
    {
        return FindRootNode(name.c_str());
    } /**< See above. */
    inline const FCDENode* FindRootNode(const fm::string& name) const
    {
        return FindRootNode(name.c_str());
    } /**< See above. */
...
public:
    ...
    inline void SetContent(const fstring& _content)
    {
        return SetContent(_content.c_str());
    } /**< See above. */
	...
	*/
    ...
    DEPRECATED(3.05A, GetChildNodeCount and GetChildNode(index))
    void GetChildNodes() const
    {
    }
    ...
    {
        FUAssert(index < children.size(), return NULL);
    ...
    inline FCDENode* AddChildNode(const fm::string& name)
    {
        return AddChildNode(name.c_str());
    } /**< See above. */
    ...
    /** Retrieves the child extra tree node with the given name.
		...
		@return The child extra tree node that matches the given name.
			...
			the given name. */
    inline FCDENode* FindChildNode(const char* name)
    {
        return const_cast<FCDENode*>(const_cast<const FCDENode*>(this)->FindChildNode(name));
    }
    const FCDENode* FindChildNode(const char* name) const; /**< See above. */
    inline FCDENode* FindChildNode(const fm::string& name)
    {
        return FindChildNode(name.c_str());
    } /**< See above. */
    inline const FCDENode* FindChildNode(const fm::string& name) const
    {
        return FindChildNode(name.c_str());
    } /**< See above. */
    ...
    inline void FindChildrenNodes(const fm::string& name, FCDENodeList& nodes) const
    {
        FindChildrenNodes(name.c_str(), nodes);
    } /**< See above. */
    ...
    inline FCDENode* FindParameter(const char* name)
    {
        return const_cast<FCDENode*>(const_cast<const FCDENode*>(this)->FindParameter(name));
    } /**< See above. */
    ...
    DEPRECATED(3.05A, GetAttributeCount and GetAttribute(index))
    ...
    {
        FUAssert(index < attributes.size(), return NULL);
    ...
    inline FCDEAttribute* AddAttribute(const char* _name, const fchar* _value)
    {
        fm::string n = _name;
        return AddAttribute(n, _value);
    } /**< See above. */
    inline FCDEAttribute* AddAttribute(const fm::string& _name, const fchar* _value)
    {
        fm::string n = _name;
        return AddAttribute(n, _value);
    } /**< See above. */
    inline FCDEAttribute* AddAttribute(const char* _name, const fstring& _value)
    {
        fm::string n = _name;
        return AddAttribute(n, _value.c_str());
    } /**< See above. */
    inline FCDEAttribute* AddAttribute(fm::string& _name, const fstring& _value)
    {
        return AddAttribute(_name, _value.c_str());
    } /**< See above. */
    inline FCDEAttribute* AddAttribute(const fm::string& _name, const fstring& _value)
    {
        fm::string n = _name;
        return AddAttribute(n, _value.c_str());
    } /**< See above. */
    template <typename T>
    inline FCDEAttribute* AddAttribute(const char* _name, const T& _value)
    {
        fm::string n = _name;
        return AddAttribute(n, TO_FSTRING(_value));
    } /**< See above. */
    template <typename T>
    inline FCDEAttribute* AddAttribute(fm::string& _name, const T& _value)
    {
        return AddAttribute(_name, TO_FSTRING(_value));
    } /**< See above. */
    template <typename T>
    inline FCDEAttribute* AddAttribute(const fm::string& _name, const T& _value)
    {
        fm::string n = _name;
        return AddAttribute(n, TO_FSTRING(_value));
    } /**< See above. */
    ...
    inline FCDEAttribute* FindAttribute(const char* name)
    {
        return const_cast<FCDEAttribute*>(const_cast<const FCDENode*>(this)->FindAttribute(name));
    }
    ...
    inline FCDENode* AddParameter(const fm::string& name, const fchar* value)
    {
        return AddParameter(name.c_str(), value);
    } /**< See above. */
    inline FCDENode* AddParameter(const char* name, const fstring& value)
    {
        return AddParameter(name, value.c_str());
    } /**< See above. */
    inline FCDENode* AddParameter(const fm::string& name, const fstring& value)
    {
        return AddParameter(name.c_str(), value.c_str());
    } /**< See above. */
    template <class T>
    inline FCDENode* AddParameter(const char* name, const T& value)
    {
        return AddParameter(name, TO_FSTRING(value));
    } /**< See above. */
    template <class T>
    inline FCDENode* AddParameter(const fm::string& name, const T& value)
    {
        return AddParameter(name.c_str(), TO_FSTRING(value));
    } /**< See above. */
...
public:
    ...
    inline void SetValue(const fstring& _value)
    {
        value = _value;
    }
};
