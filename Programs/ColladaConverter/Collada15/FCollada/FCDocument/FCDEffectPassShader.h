...
public:
    ...
    inline FCDEffectPass* GetParent()
    {
        return parent;
    }
    inline const FCDEffectPass* GetParent() const
    {
        return parent;
    } /**< See above. */
    ...
    inline FCDEffectPassBind* GetBinding(size_t index)
    {
        FUAssert(index < GetBindingCount(), return NULL);
        return bindings.at(index);
    }
    inline const FCDEffectPassBind* GetBinding(size_t index) const
    {
        FUAssert(index < GetBindingCount(), return NULL);
        return bindings.at(index);
    } /**< See above. */
    ...
    inline FCDEffectPassBind* FindBindingReference(const char* reference)
    {
        return const_cast<FCDEffectPassBind*>(const_cast<const FCDEffectPassShader*>(this)->FindBindingReference(reference));
    } /**< See above. */
    ...
    inline FCDEffectPassBind* FindBindingSymbol(const char* symbol)
    {
        return const_cast<FCDEffectPassBind*>(const_cast<const FCDEffectPassShader*>(this)->FindBindingSymbol(symbol));
    } /**< See above. */
    ...
    DEPRECATED(3.05A, binding->Release())
    ...
    inline const fstring& GetCompilerTarget() const
    {
    ...
    inline void SetCompilerTarget(const fchar* _compilerTarget)
    {
        compilerTarget = _compilerTarget;
        SetDirtyFlag();
    }
    ...
    inline const fstring& GetCompilerOptions() const
    {
    ...
    inline void SetCompilerOptions(const fchar* _compilerOptions)
    {
    ...
    inline FCDEffectCode* GetCode()
    {
        return code;
    }
    inline const FCDEffectCode* GetCode() const
    {
        return code;
    } /**< See above. */
    ...
    inline void SetCode(FCDEffectCode* _code)
    {
        code = _code;
        SetDirtyFlag();
    }
