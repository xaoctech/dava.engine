...
{
    if (!FCDEffectParameter::IsValueEqual(parameter))
        return false;
    FCDEffectParameterSurface* param = (FCDEffectParameterSurface*)parameter;

    // compage images
    size_t imgCount = this->GetImageCount();
    if (imgCount != param->GetImageCount())
        return false;

    for (size_t i = 0; i < imgCount; i++)
    {
        if (this->GetImage(i) != param->GetImage(i))
            return false;
    }
    ...
    {
        if (initMethod->GetInitType() != param->GetInitMethod()->GetInitType())
            return false;
    }
    else
    {
        if (initMethod != param->GetInitMethod())
            return false;
    }

    if (size != param->GetSize())
        return false;
    if (mipLevelCount != param->GetMipLevelCount())
        return false;
    if (generateMipmaps != param->IsGenerateMipMaps())
        return false;
    if (viewportRatio != param->GetViewportRatio())
        return false;
...
FCDEffectParameter* FCDEffectParameterSurface::Clone(FCDEffectParameter* _clone) const
{
    ...
    if (_clone == NULL)
        _clone = clone = new FCDEffectParameterSurface(const_cast<FCDocument*>(GetDocument()));
    else if (_clone->GetObjectType() == FCDEffectParameterSurface::GetClassType())
        clone = (FCDEffectParameterSurface*)_clone;

    if (_clone != NULL)
        FCDEffectParameter::Clone(_clone);
    if (clone != NULL)
    {
...
FCDEffectParameterSurfaceInit* FCDEffectParameterSurfaceInitCube::Clone(FCDEffectParameterSurfaceInit* _clone) const
{
    ...
    if (_clone == NULL)
        clone = new FCDEffectParameterSurfaceInitCube();
    else if (_clone->GetInitType() == GetInitType())
        clone = (FCDEffectParameterSurfaceInitCube*)_clone;

    if (_clone != NULL)
        FCDEffectParameterSurfaceInit::Clone(_clone);
    if (clone != NULL)
    {
...
FCDEffectParameterSurfaceInit* FCDEffectParameterSurfaceInitFrom::Clone(FCDEffectParameterSurfaceInit* _clone) const
{
    ...
    if (_clone == NULL)
        clone = new FCDEffectParameterSurfaceInitFrom();
    else if (_clone->GetInitType() == GetInitType())
        clone = (FCDEffectParameterSurfaceInitFrom*)_clone;
...
FCDEffectParameterSurfaceInit* FCDEffectParameterSurfaceInitVolume::Clone(FCDEffectParameterSurfaceInit* _clone) const
{
    ...
    if (_clone == NULL)
        clone = new FCDEffectParameterSurfaceInitVolume();
    else if (_clone->GetInitType() == GetInitType())
        clone = (FCDEffectParameterSurfaceInitVolume*)_clone;
...
FCDEffectParameterSurfaceInit* FCDEffectParameterSurfaceInitAsNull::Clone(FCDEffectParameterSurfaceInit* _clone) const
{
    ...
    if (_clone == NULL)
        clone = new FCDEffectParameterSurfaceInitAsNull();
    else if (_clone->GetInitType() == GetInitType())
        clone = (FCDEffectParameterSurfaceInitAsNull*)_clone;
...
FCDEffectParameterSurfaceInit* FCDEffectParameterSurfaceInitAsTarget::Clone(FCDEffectParameterSurfaceInit* _clone) const
{
    ...
    if (_clone == NULL)
        clone = new FCDEffectParameterSurfaceInitAsTarget();
    else if (_clone->GetInitType() == GetInitType())
        clone = (FCDEffectParameterSurfaceInitAsTarget*)_clone;
...
FCDEffectParameterSurfaceInit* FCDEffectParameterSurfaceInitPlanar::Clone(FCDEffectParameterSurfaceInit* _clone) const
{
    ...
    if (_clone == NULL)
        clone = new FCDEffectParameterSurfaceInitPlanar();
    else if (_clone->GetInitType() == GetInitType())
        clone = (FCDEffectParameterSurfaceInitPlanar*)_clone;
...
FCDEffectParameterSurfaceInit* FCDEffectParameterSurfaceInitFactory::Create(InitType type)
{
    ...
    case FCDEffectParameterSurfaceInitFactory::AS_NULL:
        parameter = new FCDEffectParameterSurfaceInitAsNull();
        break;
    case FCDEffectParameterSurfaceInitFactory::AS_TARGET:
        parameter = new FCDEffectParameterSurfaceInitAsTarget();
        break;
    case FCDEffectParameterSurfaceInitFactory::CUBE:
        parameter = new FCDEffectParameterSurfaceInitCube();
        break;
    case FCDEffectParameterSurfaceInitFactory::FROM:
        parameter = new FCDEffectParameterSurfaceInitFrom();
        break;
    case FCDEffectParameterSurfaceInitFactory::PLANAR:
        parameter = new FCDEffectParameterSurfaceInitPlanar();
        break;
    case FCDEffectParameterSurfaceInitFactory::VOLUME:
        parameter = new FCDEffectParameterSurfaceInitVolume();
        break;
    default:
        break;
    }
