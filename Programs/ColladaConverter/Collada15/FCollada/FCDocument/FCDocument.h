...
#if defined(WIN32)
template <class T>
class FCOLLADA_EXPORT FCDLibrary; /**< Trick Doxygen. */
template <class T>
class FCOLLADA_EXPORT FUUniqueStringMapT; /**< Trick Doxygen. */
#elif defined(LINUX) || defined(__APPLE__)
template <class T>
class FCDLibrary; /**< Trick Doxygen. */
template <class T>
class FUUniqueStringMapT; /**< Trick Doxygen. */
#endif // LINUX
...
public:
    ...
    inline FCDAsset* GetAsset()
    {
        return asset;
    }
    inline const FCDAsset* GetAsset() const
    {
        return asset;
    } /**< See above. */
    ...
    inline FCDVersion& GetVersion()
    {
        return *version;
    }
    inline const FCDVersion& GetVersion() const
    {
        return *version;
    } /**< See above. */
    ...
    inline FUFileManager* GetFileManager()
    {
        return fileManager;
    }
    inline const FUFileManager* GetFileManager() const
    {
        return fileManager;
    } /**< See above. */
    ...
    {
        return const_cast<FCDSceneNode*>(const_cast<const FCDocument*>(this)->GetVisualSceneInstance());
    }
    const FCDSceneNode* GetVisualSceneInstance() const; /**< See above. */
    DEPRECATED(3.04A, FCDocument::GetVisualSceneInstance)
    inline FCDSceneNode* GetVisualSceneRoot()
    {
        return GetVisualSceneInstance();
    } /**< See above. */
    DEPRECATED(3.04A, FCDocument::GetVisualSceneInstance)
    inline const FCDSceneNode* GetVisualSceneRoot() const
    {
        return GetVisualSceneInstance();
    } /**< See above. */
    ...
    inline FCDEntityReference* GetVisualSceneInstanceReference()
    {
        return visualSceneRoot;
    }
    inline const FCDEntityReference* GetVisualSceneInstanceReference() const
    {
        return visualSceneRoot;
    } /**< See above. */
    ...
    inline size_t GetPhysicsSceneInstanceCount() const
    {
        return physicsSceneRoots.size();
    }
    ...
    inline FCDPhysicsScene* GetPhysicsSceneInstance(size_t index = 0)
    {
        return const_cast<FCDPhysicsScene*>(const_cast<const FCDocument*>(this)->GetPhysicsSceneInstance(index));
    }
    const FCDPhysicsScene* GetPhysicsSceneInstance(size_t index = 0) const; /**< See above. */
    DEPRECATED(3.04A, FCDocument::GetPhysicsSceneInstance)
    inline FCDPhysicsScene* GetPhysicsSceneRoot(size_t index = 0)
    {
        return GetPhysicsSceneInstance(index);
    } /**< See above. */
    DEPRECATED(3.04A, FCDocument::GetPhysicsSceneInstance)
    inline const FCDPhysicsScene* GetPhysicsSceneRoot(size_t index = 0) const
    {
        return GetPhysicsSceneInstance(index);
    } /**< See above. */
    ...
    inline FCDEntityReference* GetPhysicsSceneInstanceReference(size_t index = 0)
    {
        if (index == 0 && physicsSceneRoots.empty())
            return NULL;
        FUAssert(index < physicsSceneRoots.size(), return NULL);
        return physicsSceneRoots[index];
    }
    inline const FCDEntityReference* GetPhysicsSceneInstanceReference(size_t index = 0) const
    {
        if (index == 0 && physicsSceneRoots.empty())
            return NULL;
        FUAssert(index < physicsSceneRoots.size(), return NULL);
    ...
    inline FUSUniqueStringMap* GetUniqueNameMap()
    {
        return uniqueNameMap;
    }
    inline const FUSUniqueStringMap* GetUniqueNameMap() const
    {
        return uniqueNameMap;
    } /**< See above. */
    ...
    inline FCDExternalReferenceManager* GetExternalReferenceManager()
    {
        return externalReferenceManager;
    }
    inline const FCDExternalReferenceManager* GetExternalReferenceManager() const
    {
        return externalReferenceManager;
    } /**< See above. */
    ...
    inline void SetEndTime(float time)
    {
        endTime = time;
        hasEndTime = true;
    }
    ...
    inline FCDLayerList& GetLayers()
    {
        return layers;
    }
    inline const FCDLayerList& GetLayers() const
    {
        return layers;
    } /**< See above. */
    ...
    /** Retrieves a specific entity layer contained within the document.
		...
		@return The entity layer. This pointer will be NULL if the index
			is out-of-bounds. */
    inline FCDLayer* GetLayer(size_t index)
    {
        FUAssert(index < GetLayerCount(), return NULL);
        return layers.at(index);
    }
    inline const FCDLayer* GetLayer(size_t index) const
    {
        FUAssert(index < GetLayerCount(), return NULL);
        return layers.at(index);
    } /**< See above. */
    ...
    inline FCDAnimationLibrary* GetAnimationLibrary()
    {
        return animationLibrary;
    }
    inline const FCDAnimationLibrary* GetAnimationLibrary() const
    {
        return animationLibrary;
    } /**< See above. */
    ...
    inline FCDAnimationClipLibrary* GetAnimationClipLibrary()
    {
        return animationClipLibrary;
    }
    inline const FCDAnimationClipLibrary* GetAnimationClipLibrary() const
    {
        return animationClipLibrary;
    } /**< See above. */
    ...
    inline FCDCameraLibrary* GetCameraLibrary()
    {
        return cameraLibrary;
    }
    inline const FCDCameraLibrary* GetCameraLibrary() const
    {
        return cameraLibrary;
    } /**< See above. */
    ...
    inline FCDControllerLibrary* GetControllerLibrary()
    {
        return controllerLibrary;
    }
    inline const FCDControllerLibrary* GetControllerLibrary() const
    {
        return controllerLibrary;
    } /**< See above. */
    ...
    inline FCDGeometryLibrary* GetGeometryLibrary()
    {
        return geometryLibrary;
    }
    inline const FCDGeometryLibrary* GetGeometryLibrary() const
    {
        return geometryLibrary;
    } /**< See above. */
    ...
    inline FCDForceFieldLibrary* GetForceFieldLibrary()
    {
        return forceFieldLibrary;
    }
    inline const FCDForceFieldLibrary* GetForceFieldLibrary() const
    {
        return forceFieldLibrary;
    } /**< See above. */
    ...
    inline FCDImageLibrary* GetImageLibrary()
    {
        return imageLibrary;
    }
    inline const FCDImageLibrary* GetImageLibrary() const
    {
        return imageLibrary;
    } /**< See above. */
    ...
    inline FCDLightLibrary* GetLightLibrary()
    {
        return lightLibrary;
    }
    inline const FCDLightLibrary* GetLightLibrary() const
    {
        return lightLibrary;
    } /**< See above. */
    ...
    inline FCDMaterialLibrary* GetMaterialLibrary()
    {
        return materialLibrary;
    }
    inline const FCDMaterialLibrary* GetMaterialLibrary() const
    {
        return materialLibrary;
    } /**< See above. */
    ...
    inline FCDEffectLibrary* GetEffectLibrary()
    {
        return effectLibrary;
    }
    inline const FCDEffectLibrary* GetEffectLibrary() const
    {
        return effectLibrary;
    } /**< See above. */
    ...
    inline FCDVisualSceneNodeLibrary* GetVisualSceneLibrary()
    {
        return visualSceneLibrary;
    }
    inline const FCDVisualSceneNodeLibrary* GetVisualSceneLibrary() const
    {
        return visualSceneLibrary;
    } /**< See above. */
    ...
    inline FCDPhysicsModelLibrary* GetPhysicsModelLibrary()
    {
        return physicsModelLibrary;
    }
    inline const FCDPhysicsModelLibrary* GetPhysicsModelLibrary() const
    {
        return physicsModelLibrary;
    } /**< See above. */
    ...
    inline FCDPhysicsMaterialLibrary* GetPhysicsMaterialLibrary()
    {
        return physicsMaterialLibrary;
    }
    inline const FCDPhysicsMaterialLibrary* GetPhysicsMaterialLibrary() const
    {
        return physicsMaterialLibrary;
    } /**< See above. */
    ...
    inline FCDPhysicsSceneLibrary* GetPhysicsSceneLibrary()
    {
        return physicsSceneLibrary;
    }
    inline const FCDPhysicsSceneLibrary* GetPhysicsSceneLibrary() const
    {
        return physicsSceneLibrary;
    } /**< See above. */
    ...
    inline FCDEmitterLibrary* GetEmitterLibrary()
    {
        return emitterLibrary;
    }
    inline const FCDEmitterLibrary* GetEmitterLibrary() const
    {
        return emitterLibrary;
    } /**< See above. */
    ...
    inline FCDSceneNode* FindSceneNode(const char* daeId)
    {
        return const_cast<FCDSceneNode*>(const_cast<const FCDocument*>(this)->FindSceneNode(daeId));
    }
    ...
    inline void RegisterExtraTree(FCDExtra* tree)
    {
        extraTrees.insert(tree, tree);
    }

    /** [INTERNAL] Unregisters an extra tree of the document.
		All extra trees are listed within the document to support extra-technique plug-ins.
		@param tree The extra tree to un-list from the document. */
    inline void UnregisterExtraTree(FCDExtra* tree)
    {
        FUAssert(extraTrees.find(tree) != extraTrees.end(), return );
        extraTrees.erase(tree);
    }
    ...
    inline FCDExtraSet& GetExtraTrees()
    {
        return extraTrees;
    }
};
