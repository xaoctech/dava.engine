...
public:
    ...
    DEPRECATED(3.05A, GetProjectionType() == FCDCamera::PERSPECTIVE)
    ...
    DEPRECATED(3.05A, SetProjectionType(FCDCamera::PERSPECTIVE))
    ...
    inline bool HasHorizontalFov() const
    {
        return GetHasHorizontalViewFlag();
    }
    ...
    inline bool HasVerticalFov() const
    {
        return GetHasVerticalViewFlag();
    }
    ...
    inline FCDParameterAnimatableFloat& GetFovX()
    {
        return viewX;
    }
    inline const FCDParameterAnimatableFloat& GetFovX() const
    {
        return viewX;
    } /**< See above. */
    ...
    /** Retrieves the vertical field of view. Before retrieving this value, 
		...
		@return The horizontal field of view, in degrees. */
    inline FCDParameterAnimatableFloat& GetFovY()
    {
        return viewY;
    }
    inline const FCDParameterAnimatableFloat& GetFovY() const
    {
        return viewY;
    } /**< See above. */
    ...
    DEPRECATED(3.05A, GetProjectionType() == FCDCamera::ORTHOGRAPHIC)
    ...
    DEPRECATED(3.05A, SetProjectionType(FCDCamera::ORTHOGRAPHIC))
    ...
    inline bool HasHorizontalMag() const
    {
        return GetHasHorizontalViewFlag();
    }
    ...
    inline bool HasVerticalMag() const
    {
        return GetHasVerticalViewFlag();
    }
    ...
    inline FCDParameterAnimatableFloat& GetMagX()
    {
        return viewX;
    }
    inline const FCDParameterAnimatableFloat& GetMagX() const
    {
        return viewX;
    } /**< See above. */
    ...
    inline FCDParameterAnimatableFloat& GetMagY()
    {
        return viewY;
    }
    inline const FCDParameterAnimatableFloat& GetMagY() const
    {
        return viewY;
    } /**< See above. */
    ...
    inline void SetMagX(float magX)
    {
        return SetFovX(magX);
    }
    ...
    inline void SetMagY(float magY)
    {
        return SetFovY(magY);
    }
    ...
    inline FCDParameterAnimatableFloat& GetNearZ()
    {
        return nearZ;
    }
    inline const FCDParameterAnimatableFloat& GetNearZ() const
    {
        return nearZ;
    } /**< See above. */
    ...
    inline FCDParameterAnimatableFloat& GetFarZ()
    {
        return farZ;
    }
    inline const FCDParameterAnimatableFloat& GetFarZ() const
    {
        return farZ;
    } /**< See above. */
    ...
    {
        return !(GetHasVerticalViewFlag() && GetHasHorizontalViewFlag());
    }
    ...
    inline FCDParameterAnimatableFloat& GetAspectRatio()
    {
        return aspectRatio;
    }
    inline const FCDParameterAnimatableFloat& GetAspectRatio() const
    {
        return aspectRatio;
    } /**< See above. */
    ...
    inline void SetNearZ(float _nearZ)
    {
        nearZ = _nearZ;
        SetDirtyFlag();
    }
    ...
    inline void SetFarZ(float _farZ)
    {
        farZ = _farZ;
        SetDirtyFlag();
    }
