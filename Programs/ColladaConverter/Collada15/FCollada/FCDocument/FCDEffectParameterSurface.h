...
public:
    ...
    {
        return index < images.size() ? images.at(index) : NULL;
    }
	...
	*/
    ...
    inline FCDFormatHint* GetFormatHint()
    {
        return formatHint;
    }
    inline const FCDFormatHint* GetFormatHint() const
    {
        return formatHint;
    }
};
...
public:
    ...
    {
        return FCDEffectParameterSurfaceInitFactory::CUBE;
    }
...
public:
    ...
    virtual FCDEffectParameterSurfaceInitFactory::InitType GetInitType() const
    {
        return FCDEffectParameterSurfaceInitFactory::VOLUME;
    }
...
public:
    ...
    virtual FCDEffectParameterSurfaceInitFactory::InitType GetInitType() const
    {
        return FCDEffectParameterSurfaceInitFactory::FROM;
    }
...
public:
    ...
    virtual FCDEffectParameterSurfaceInitFactory::InitType GetInitType() const
    {
        return FCDEffectParameterSurfaceInitFactory::AS_NULL;
    }
...
public:
    ...
    virtual FCDEffectParameterSurfaceInitFactory::InitType GetInitType() const
    {
        return FCDEffectParameterSurfaceInitFactory::AS_TARGET;
    }
...
public:
    ...
    virtual FCDEffectParameterSurfaceInitFactory::InitType GetInitType() const
    {
        return FCDEffectParameterSurfaceInitFactory::PLANAR;
    }
