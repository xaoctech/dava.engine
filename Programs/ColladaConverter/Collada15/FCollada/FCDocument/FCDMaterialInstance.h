...
public:
    ...
    {
        return (FUDaeGeometryInput::Semantic)*inputSemantic;
    }
};
...
public:
    ...
    DEPRECATED(3.05A, HasType(FCDMaterialInstance::GetClassType()))
    ...
    inline FCDEntityInstance* GetParent()
    {
        return parent;
    }
    inline const FCDEntityInstance* GetParent() const
    {
        return parent;
    } /**< See above. */
    ...
    inline const fstring& GetSemantic() const
    {
        return semantic;
    }
    ...
    inline void SetSemantic(const fchar* _semantic)
    {
        semantic = _semantic;
        SetDirtyFlag();
    }
    inline void SetSemantic(const fstring& _semantic)
    {
        semantic = _semantic;
        SetDirtyFlag();
    } /**< See above. */
    ...
    inline FCDMaterial* GetMaterial()
    {
        return (FCDMaterial*)GetEntity();
    }
    inline const FCDMaterial* GetMaterial() const
    {
        return (const FCDMaterial*)GetEntity();
    } /**< See above. */

    /** Sets the material entity used by this instance.
		@param _material The new instanced material. */
    inline void SetMaterial(FCDMaterial* _material)
    {
        SetEntity((FCDEntity*)_material);
    }
    ...
    DEPRECATED(3.05A, GetBindingCount and GetBinding(index))
    inline void GetBindings() const
    {
    }
    ...
    inline FCDMaterialInstanceBind* GetBinding(size_t index)
    {
        FUAssert(index < bindings.size(), return NULL);
        return bindings.at(index);
    }
    inline const FCDMaterialInstanceBind* GetBinding(size_t index) const
    {
        FUAssert(index < bindings.size(), return NULL);
        return bindings.at(index);
    } /**< See above. */
    ...
    DEPRECATED(3.05A, GetVertexInputBindingCount and GetVertexInputBinding(index))
    ...
    inline size_t GetVertexInputBindingCount() const
    {
    ...
    inline FCDMaterialInstanceBindVertexInput* GetVertexInputBinding(size_t index)
    {
        FUAssert(index < vertexBindings.size(), return NULL);
        return vertexBindings.at(index);
    }
    inline const FCDMaterialInstanceBindVertexInput* GetVertexInputBinding(size_t index) const
    {
        FUAssert(index < vertexBindings.size(), return NULL);
        return vertexBindings.at(index);
    } /**< See above. */
    ...
    inline FCDMaterialInstanceBindVertexInput* FindVertexInputBinding(const char* semantic)
    {
        return const_cast<FCDMaterialInstanceBindVertexInput*>(const_cast<const FCDMaterialInstance*>(this)->FindVertexInputBinding(semantic));
    }
