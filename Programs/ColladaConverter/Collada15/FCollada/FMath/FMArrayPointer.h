...
public:
    ...
    inline T*& front()
    {
        return (T*&)Parent::front();
    }
    inline const T*& front() const
    {
        return (const T*&)Parent::front();
    } /**< See above. */
    ...
    inline T*& back()
    {
        return (T*&)Parent::back();
    }
    inline const T*& back() const
    {
        return (const T*&)Parent::back();
    } /**< See above. */
    ...
    {
        return (T*&)Parent::at(index);
    }
    inline const T*& at(size_t index) const
    {
        return (const T*&)Parent::at(index);
    } /**< See above. */
    ...
    {
        Parent::iterator f = Parent::find(item);
        return begin() + (f - Parent::begin());
    }
    inline const_iterator find(const T* item) const
    {
        Parent::const_iterator f = Parent::find(item);
        return begin() + (f - Parent::begin());
    } /**< See above. */
