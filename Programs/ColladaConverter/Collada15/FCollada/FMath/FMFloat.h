...
inline bool IsEquivalent(float f1, float f2)
{
...
inline bool IsEquivalent(float f1, float f2, float tolerance)
{
...
inline bool IsEquivalent(double f1, double f2)
{
...
inline bool IsEquivalent(double f1, double f2, double tolerance)
{
    return f1 - f2 < tolerance && f2 - f1 < tolerance;
}
