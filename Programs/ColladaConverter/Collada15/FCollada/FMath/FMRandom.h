...
/** Retrieves one random unsigned integer within a given range.
		...
		@return A random unsigned integer. */
inline uint32 GetUInt32(uint32 rangeEnd)
{
    return GetUInt32() % rangeEnd;
}
...
/** Retrieves one random unsigned integer within a given range.
		...
		@param rangeEnd The end of the wanted range.
		@return A random unsigned integer. */
inline uint32 GetUInt32(uint32 rangeStart, uint32 rangeEnd)
{
    return (GetUInt32() % (rangeEnd - rangeStart)) + rangeStart;
}
...
/** Retrieves one random signed integer.
		...
		@param rangeEnd The end of the wanted range.
		@return A random signed integer. */
inline int32 GetInt32(int32 rangeStart, int32 rangeEnd)
{
    return (((int32)GetUInt32()) % (rangeEnd - rangeStart)) + rangeStart;
}
...
/** Retrieves one random floating-point value within a given range.
		...
		@param rangeEnd The end of the wanted range.
		@return A random floating-point value. */
inline float GetFloat(float rangeEnd)
{
    return GetFloat() * rangeEnd;
}
...
/** Retrieves one random floating-point value within a given range.
		...
		@param rangeEnd The end of the wanted range.
		@return A random floating-point value. */
inline float GetFloat(float rangeStart, float rangeEnd)
{
    return GetFloat() * (rangeEnd - rangeStart) + rangeStart;
}
};
