...
/** Creates an empty FMMatrix44.
    ...
    inline const FMVector3& GetTranslation() const
    {
        return GetAxis(FMath::TRANS);
    }
    inline FMVector3& GetTranslation()
    {
        return GetAxis(FMath::TRANS);
    } /**< See Above */
    ...
    inline void SetTranslation(const FMVector3& translation)
    {
    ...
    inline const FMVector3& GetAxis(FMath::AXIS axis) const
    {
        return *(FMVector3*)(size_t)(m[axis]);
    }
    inline FMVector3& GetAxis(FMath::AXIS axis)
    {
        return *(FMVector3*)(size_t)(m[axis]);
    } /**< See above */
...
inline bool operator==(const FMMatrix44& m1, const FMMatrix44& m2)
{
    return IsEquivalent(m1, m2);
} /**< See above. */
...
inline FMMatrix44& operator*=(FMMatrix44& m1, const FMMatrix44& m2)
{
    return m1 = m1 * m2;
}
