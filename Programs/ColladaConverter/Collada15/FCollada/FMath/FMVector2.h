...
/** Creates an empty FMVector2. */
    ...
    inline FMVector2 Normalize() const
    {
        float l = Length();
        return (l > 0.0f) ? FMVector2(x / l, y / l) : FMVector2::XAxis;
    }
    ...
    /** Adds two vector.
		...
		@return This vector. */
    inline FMVector2& operator+=(const FMVector2& a)
    {
        u += a.u;
        v += a.v;
        return *this;
    ...
    /** Multiplies this vector by a scaler.
		...
		@return This vector. */
    inline FMVector2& operator*=(float a)
    {
        u *= a;
        v *= a;
        return *this;
    ...
    /** Assign this vector to the given float array.
		...
		@return This vector. */
    inline FMVector2& operator=(const float* f)
    {
        u = *f;
        v = *(f + 1);
        return *this;
...
inline FMVector2 operator+(const FMVector2& a, const FMVector2& b)
{
    return FMVector2(a.u + b.u, a.v + b.v);
}
 ...
 */
inline float operator*(const FMVector2& a, const FMVector2& b)
{
...
inline FMVector2 operator*(const FMVector2& a, float b)
{
    return FMVector2(a.u * b, a.v * b);
}
...
inline FMVector2 operator*(float a, const FMVector2& b)
{
    return FMVector2(a * b.u, a * b.v);
}
...
inline bool IsEquivalent(const FMVector2& a, const FMVector2& b)
{
    return IsEquivalent(a.x, b.x) && IsEquivalent(a.y, b.y);
}
inline bool operator==(const FMVector2& a, const FMVector2& b)
{
    return IsEquivalent(a.x, b.x) && IsEquivalent(a.y, b.y);
} /**< See above. */
