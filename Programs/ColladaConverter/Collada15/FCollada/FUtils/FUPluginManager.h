...
public:
    ...
    inline size_t GetLoadedPluginCount()
    {
    ...
    inline FUPlugin** GetLoadedPlugins()
    {
        return loadedPlugins.begin();
    }
    inline const FUPlugin** GetLoadedPlugins() const
    {
        return loadedPlugins.begin();
    } /**< See above. */
    ...
    inline FUPlugin* GetLoadedPlugin(size_t index)
    {
        FUAssert(index < loadedPlugins.size(), return NULL);
        return loadedPlugins.at(index);
    }
    inline const FUPlugin* GetLoadedPlugin(size_t index) const
    {
        FUAssert(index < loadedPlugins.size(), return NULL);
        return loadedPlugins.at(index);
    } /**< See above. */
