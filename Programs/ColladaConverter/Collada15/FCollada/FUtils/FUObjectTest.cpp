...
public:
    FUTObject1(FUObjectContainer<FUTrackable>* container)
    {
...
public:
    FUTObject2(FUObjectContainer<FUTrackable>* container)
    {
        container->push_back(this);
    }
};
...
public:
    FUTObject1Up(FUObjectContainer<FUTrackable>* container)
        : FUTObject1(container)
    {
    }
};
