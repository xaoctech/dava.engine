...
>
class StaticArrayBase : public StoragePolicy<TYPE, COUNT> // wg: renamed due to scaleform conflicts
{
public:
	...
	inline
	typename StaticArrayBase<TYPE, COUNT, StoragePolicy>::iterator end() 
	{
		return this->data_ + this->size_;
	}

	inline
	typename StaticArrayBase<TYPE, COUNT, StoragePolicy>::const_iterator end() const 
	{
		return this->data_ + this->size_;
	}
};
...
class StaticArray :
	public StaticArrayBase<TYPE, COUNT, StaticStoragePolicy >
{
public:
	/**
	 * Due to template issues in gcc all constructors have to be empty,
...
class DynamicEmbeddedArray :
	public StaticArrayBase<TYPE, COUNT, DynamicEmbeddedStoragePolicy >
{
public:
	/**
	 * Due to template issues in gcc all constructors have to be empty,
...
class DynamicEmbeddedArrayWithWarning :
	public StaticArrayBase<TYPE, COUNT,DynamicEmbeddedStoragePolicyWithWarning >
{
public:
	/**
	 * Due to template issues in gcc all constructors have to be empty,
...
class DynamicArray :
	public StaticArrayBase<TYPE, 0, DynamicStoragePolicy >
{
public:
	/**
	 * Due to template issues in gcc all constructors have to be empty,
...
template < typename TYPE > 
class ExternalArray :
	public StaticArrayBase<TYPE, 0, ExternalStoragePolicy>
{
public:
	ExternalArray()
	{
