...
// used for std containers for case insensitive comparison
struct StrICmp
{
	bool operator () ( const BW::string &str1, const BW::string &str2 ) const
	{
		return bw_stricmp( str1.c_str(), str2.c_str() ) < 0;
	}
};
