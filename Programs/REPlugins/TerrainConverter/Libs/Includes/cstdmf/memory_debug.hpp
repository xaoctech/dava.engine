...
public:
	...
	size_t printLiveAllocationsOrdered(FILE* file = 0);
...
private:
	...
	struct AllocationInfo
	{
		...
		// WG extensions
		detail::DLink link; // std::unordered_map guarantees it's elements pointers validity between rehashes (see C++11 standard, clause 23.2.5/8)
		uint64 time;
		size_t sizeRequested;
		size_t slotAllocations;
		size_t slotBytes;
	};
	...
	detail::DLink liveAllocationsOrdered_;
