...
public:
	...
	CSTDMF_DLL static bool shouldAccept( DebugMessagePriority componentPriority,
		DebugMessagePriority messagePriority,
		const BW::string & categoryName = BW::string() );
	bool shouldAcceptCategory( const BW::string & categoryName,
		DebugMessagePriority messagePriority ) const;
	...
	bool handleMessage( DebugMessagePriority componentPriority,
...
private:
	...
	mutable CategoriesMap suppressedCategories_;
