...
public:
	...
	const HullContents * testPoint( const DAVA::Vector3 & point ) const;
	...
	private:
		Traversal( const HullTree * pTree, const DAVA::Vector3 & source,
				const DAVA::Vector3 & extent, float radius ) :
	...
	Traversal traverse( const DAVA::Vector3 & source, const DAVA::Vector3 & extent,
...
private:
	...
	public:
		Portal3D() { }
		Portal3D( const PlaneEq & plane, DAVA::Vector<DAVA::Vector2> & portal );

		typedef std::vector<DAVA::Vector3> V3Vector;
