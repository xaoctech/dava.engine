...
public:
	...
	bool save( DataSection * result ) const;
    ...
    DAVA::String name() const					{ return name_; }
	void name( const DAVA::String & name )		{ name_ = name; }
...
public:
	...
	// for it.
	bool save( DataSection * result, const WorldTriangle * pFront ) const;
	...
	void wg_visitTriangles(	
							const DAVA::Vector3& boxCenter, 
							const DAVA::Vector3& boxE1,
							const DAVA::Vector3& boxE2,
							const DAVA::Vector3& boxE3,
...
private:
	...
	bool intersectsThisNode(const DAVA::Vector3 & start,
						const DAVA::Vector3 &		end,
						float &				dist,
