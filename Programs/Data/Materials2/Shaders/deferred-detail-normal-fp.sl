...
fragment_out fp_main(fragment_in input)
{
    ...
    NormalSampleResult normalMapSample = SampleNormal(input.uv.xy, input.tbnToWorld1.w, normalScale, ambientOcclusion);
    ambientOcclusion = normalMapSample.ao;
    ...
    float3 n = normalize(float3(dot(normalMapSample.normal, input.tbnToWorld0), dot(normalMapSample.normal, input.tbnToWorld1.xyz), dot(normalMapSample.normal, input.tbnToWorld2.xyz)));
#else
