...
fragment_out fp_main(fragment_in input)
{
    ...
    float3 reflectionColor = tex2D(reflectionTexture, texturePos + waveOffset * reflectionDistortion).rgb;
    texturePos.y = 1.0 - texturePos.y;
    float3 refractionColor = tex2D(refractionTexture, texturePos + waveOffset * refractionDistortion).rgb * refractionTintColor;
