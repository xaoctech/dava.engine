...
#if WIND_ANIMATION
[material][a] property float2 trunkOscillationParams;
#endif
...
[material][a] property float treeLeafOcclusionMul = 0.5;
    ...
    #if WIND_ANIMATION
[material][a] property float2 leafOscillationParams; //x: A*sin(T); y: A*cos(T);
    #endif
    
    #if SPHERICAL_LIT
[material][a] property float speedTreeLightSmoothing;
    #endif
#endif
...
[material][sh] property float4 sphericalHarmonics[7] : "bigarray";
    #elif SPHERICAL_HARMONICS_4
[material][sh] property float4 sphericalHarmonics[3] : "bigarray";
    #else
[material][sh] property float4 sphericalHarmonics;
    #endif
#endif
