...
def get_input_context():
    ...
    parser.add_argument('--gpu', nargs='?', choices = cg.g_allowed_gpu,
...
def do(context=g_default_context):
    ...
    convertGraphics = [sys.executable, 'convert_graphics.py', '--gpu', context['gpu'],
    ...
    if context['optimized']:
        convertGraphics.extend(['--resources', 'resources'])
