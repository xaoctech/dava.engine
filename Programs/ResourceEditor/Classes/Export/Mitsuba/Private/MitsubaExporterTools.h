...
extern const DAVA::String kRoughPlastic;
extern const DAVA::String kAlbedo;
extern const DAVA::String kNormalMap;
extern const DAVA::String kDiffuseReflectance;
extern const DAVA::String kSpecularReflectance;
