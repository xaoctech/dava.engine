...
{
    if (commandNotification.MatchCommandIDs({ CMDID_PARTICLE_LAYER_REMOVE, CMDID_PARTICLE_LAYER_MOVE, CMDID_PARTICLE_FORCE_REMOVE, CMDID_PARTICLE_SIMPLIFIED_FORCE_MOVE, CMDID_PARTICLE_DRAG_FORCE_MOVE }))
    {
        EmitChanged();
    }
}
