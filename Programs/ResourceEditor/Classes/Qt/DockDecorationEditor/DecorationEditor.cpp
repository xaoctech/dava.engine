...
DAVA_REFLECTION_IMPL(DecorationEditor)
{
    ...
    .Field("decorationPath", &DecorationEditor::GetDecorationPath, &DecorationEditor::SetDecorationPath)[DAVA::Meta<SceneFileMeta, DAVA::Metas::File>("All(*.prefab);; Prefab(*.prefab);")]
