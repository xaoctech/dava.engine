...
Entity* CreateLandscapeEnity(const FilePath& scenePathname)
{
    ...
    setupTexture("landscape.albedo.tex", NMaterialTextureName::TEXTURE_ALBEDO);
    setupTexture("landscape.tilemask.tex", Landscape::TEXTURE_TILEMASK);
    setupTexture("landscape.tileTexture0.tex", Landscape::TEXTURE_ALBEDO_TILE0);
    setupTexture("landscape.tileTexture1.tex", Landscape::TEXTURE_ALBEDO_TILE1);
    setupTexture("landscape.tileTexture2.tex", Landscape::TEXTURE_ALBEDO_TILE2);
    setupTexture("landscape.tileTexture3.tex", Landscape::TEXTURE_ALBEDO_TILE3);
...
Entity* CreateLightsEntity(const FilePath& scenePathname)
{
    ...
    dynamicLight->SetLightType(Light::TYPE_SUN);
    dynamicLight->SetIsDynamic(true);
    dynamicLight->SetCastsShadow(true);
    ...
    notDynamicLight->SetLightType(Light::TYPE_DIRECTIONAL);
    notDynamicLight->SetIsDynamic(false);
    notDynamicLight->SetCastsShadow(false);
    ...
    skyLight->SetLightType(Light::TYPE_SKY);
    skyLight->SetIsDynamic(false);
    skyLight->SetCastsShadow(false);
