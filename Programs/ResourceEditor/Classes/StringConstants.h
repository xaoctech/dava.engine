...
static const DAVA::String SHORTCUT_VISIBILITY_TOOL_SET_POINT = "visibility-tool.set-point";
static const DAVA::String SHORTCUT_VISIBILITY_TOOL_SET_AREA = "visibility-tool.set-area";
