...
DAVA_VIRTUAL_REFLECTION_IMPL(GlobalSceneSettings)
{
    ...
    .Field("cameraRestoreFullParameters", &GlobalSceneSettings::cameraRestoreFullParameters)[DAVA::M::DisplayName("Restore all camera parameters on scene reload"), DAVA::M::Group("Camera")]
