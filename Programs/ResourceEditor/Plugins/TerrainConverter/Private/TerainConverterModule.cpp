...
DECLARE_PLUGIN(TerrainConverterGUIModule, DAVA::TArc::TArcPlugin::PluginDescriptor("ResourceEditor", "TerrainConverter", "Terrain Converter for Blitz", "Terrain Converter for Blitz", 0, 1));
