...
DAVA::KeyedArchive* CreateOptions()
{
    ...
    appOptions->SetInt32("max_texture_count", 1024 * 4);
    appOptions->SetInt32("max_texture_set_count", 1024 * 4);
    appOptions->SetInt32("max_sampler_state_count", 256);
    appOptions->SetInt32("max_pipeline_state_count", 1024);
    appOptions->SetInt32("max_depthstencil_state_count", 256);
    appOptions->SetInt32("max_render_pass_count", 16 * 1024);
