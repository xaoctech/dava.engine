...
DAVA_TESTCLASS (ReflectionCollectionTest)
{
    ...
    void AddInsertRemoveMapTest(const DAVA::Reflection& ref, const TIter& startExpected, const TIter& endExpected)
    {
        for (TIter i = startExpected; i != endExpected; ++i)
        {
            DAVA::Reflection r = ref.GetField(DAVA::Any(i->first));
        ...
        TEST_VERIFY(ref.GetField(DAVA::Any(int(5))).GetValue().Cast<int>() == 5);
        TEST_VERIFY(ref.AddField(int(6), int(6)));
        TEST_VERIFY(ref.GetField(DAVA::Any(int(6))).GetValue().Cast<int>() == 6);
        TEST_VERIFY(ref.AddField(int(7), int(7)));
        TEST_VERIFY(ref.GetField(DAVA::Any(int(5))).GetValue().Cast<int>() == 5);
        TEST_VERIFY(ref.GetField(DAVA::Any(int(6))).GetValue().Cast<int>() == 6);
        TEST_VERIFY(ref.GetField(DAVA::Any(int(7))).GetValue().Cast<int>() == 7);
    ...
    void AddInsertRemoveSetTest(const DAVA::Reflection& ref, const TIter& startExpected, const TIter& endExpected)
    {
        for (TIter i = startExpected; i != endExpected; ++i)
        {
            DAVA::Reflection r = ref.GetField(DAVA::Any(*i));
            int v = r.GetValue().Cast<int>();
            TEST_VERIFY((*i) == v);
        }
        ...
        TEST_VERIFY(ref.RemoveField(DAVA::Any(int(7))));
        TEST_VERIFY(ref.RemoveField(DAVA::Any(int(5))));
        TEST_VERIFY(!ref.RemoveField(DAVA::Any(int(5))));

        DAVA::Reflection r = ref.GetField(DAVA::Any(int(0)));
