...
DAVA_TESTCLASS (DateTimeTest)
{
    DAVA_TEST (TestFunction)
    {
        ...
        const bool isUTC3 = DateTime::Now().GetTimeZoneOffset() == 3 * 3600;
        if (isUTC3)
        {
            TEST_VERIFY(FormatDateTime(DateTime(2001, 1, 1, 0, 0, 0, 3 * 3600).ConvertToLocalTimeZone()) ==
                        "2001-01-01 00:00:00+10800");
            TEST_VERIFY(FormatDateTime(DateTime(2001, 1, 1, 0, 0, 0, 3 * 3600).ConvertToTimeZone(0)) ==
                        "2001-00-31 21:00:00+0");
            TEST_VERIFY(FormatDateTime(DateTime(2001, 1, 1, 0, 0, 0, 3 * 3600).ConvertToTimeZone(-3 * 3600)) ==
                        "2001-00-31 18:00:00-10800");
        }
        ...
        }
        {
            ...
            TEST_VERIFY(x_date_en == L"9/8/1984" || x_date_en == L"9/8/84" || x_date_en == L"09/08/1984");
            ...
            TEST_VERIFY(x_time_en == L"4:30:22 PM" || x_time_en == L"04:30:22 PM");
