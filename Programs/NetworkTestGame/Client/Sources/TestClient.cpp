...
DAVA::KeyedArchive* TestClient::CreateOptions()
{
    using namespace DAVA;
    KeyedArchive* appOptions = new KeyedArchive();
    appOptions->SetInt32("shader_const_buffer_size", 15 * 1024 * 1024);
    appOptions->SetInt32("max_index_buffer:_count", 8 * 1024);
    appOptions->SetInt32("max_vertex_buffer_count", 8 * 1024);
    appOptions->SetInt32("max_const_buffer_count", 63 * 1024);
    appOptions->SetInt32("max_texture_count", 4048);
    appOptions->SetInt32("max_texture_set_count", 4048);
    appOptions->SetInt32("max_sampler_state_count", 1028);
    appOptions->SetInt32("max_pipeline_state_count", 2024);
    appOptions->SetInt32("max_depthstencil_state_count", 1024);
    appOptions->SetInt32("max_render_pass_count", 4096);
    appOptions->SetInt32("max_command_buffer_count", 4096);
    appOptions->SetInt32("max_packet_list_count", 4096);
