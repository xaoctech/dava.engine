...
def _build_win32(working_directory_path, root_project_path):
    ...
    lib_path_x86_debug = os.path.join(build_folder86, 'Debug', 'gmock.lib')
    lib_path_x86_release = os.path.join(build_folder86,'Release', 'gmock.lib')
    lib_path_x64_debug = os.path.join(build_folder64, 'Debug', 'gmock.lib')
    lib_path_x64_release = os.path.join(build_folder64, 'Release', 'gmock.lib')

    win_libs_folder = os.path.join(root_project_path, 'Modules/TArc/Libs/Win32/')
    build_utils.clear_files(win_libs_folder, '*/*/*.lib')

    shutil.copyfile(lib_path_x86_debug, os.path.join(win_libs_folder, 'x86/Debug/gmock.lib'))
    shutil.copyfile(lib_path_x86_release, os.path.join(win_libs_folder, 'x86/Release/gmock.lib'))
    shutil.copyfile(lib_path_x64_debug, os.path.join(win_libs_folder, 'x64/Debug/gmock.lib'))
    shutil.copyfile(lib_path_x64_release, os.path.join(win_libs_folder, 'x64/Release/gmock.lib'))
...
def _build_macos(working_directory_path, root_project_path):
    ...
    shutil.copyfile(lib_path_debug, os.path.join(mac_libs_folder, 'Debug/libgmock.a'))
    shutil.copyfile(lib_path_release, os.path.join(mac_libs_folder, 'Release/libgmock.a'))
