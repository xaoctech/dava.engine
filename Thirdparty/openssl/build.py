...
def __build_android(working_directory_path, root_project_path):
	...
	install_dir_arm = os.path.join(working_directory_path, 'install_arm')
	configure_args = ['no-shared', 'no-whirlpool', 'no-asm', 'no-cast', 'no-idea', 'no-camellia', 'no-comp', 'no-hw', 'no-engine']
	build_utils.build_with_autotools(source_folder_path, configure_args, install_dir_arm, env=__get_android_env_arm(source_folder_path, root_project_path))

	install_dir_x86 = os.path.join(working_directory_path, 'install_x86')
	configure_args = ['no-shared', 'no-whirlpool', 'no-asm', 'no-cast', 'no-idea', 'no-camellia', 'no-comp', 'no-hw', 'no-engine']
	build_utils.build_with_autotools(source_folder_path, configure_args, install_dir_x86, env=__get_android_env_x86(source_folder_path, root_project_path))
