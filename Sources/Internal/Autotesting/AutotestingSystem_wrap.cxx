...
static int _wrap_AutotestingSystemLua_LeftMouseClickUp(lua_State* L) {
    ...
    SWIG_check_num_args("DAVA::AutotestingSystemLua::LeftMouseClickUp",1,1)
...
static int _wrap_AutotestingSystemLua_ScrollToControl(lua_State* L) {
  ...
  if(!lua_isstring(L,2)) SWIG_fail_arg("DAVA::AutotestingSystemLua::ScrollToControl",2,"DAVA::String const &");
...
static int _wrap_AutotestingSystemLua_GetServerQueueState(lua_State* L) {
  ...
  if(!lua_isstring(L,2)) SWIG_fail_arg("DAVA::AutotestingSystemLua::GetServerQueueState",2,"DAVA::String const &");
...
static int _wrap_AutotestingSystemLua_SetServerQueueState(lua_State* L) {
  ...
  if(!lua_isstring(L,2)) SWIG_fail_arg("DAVA::AutotestingSystemLua::SetServerQueueState",2,"DAVA::String const &");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("DAVA::AutotestingSystemLua::SetServerQueueState",3,"DAVA::int32");
...
static int _wrap_AutotestingSystemLua_ReadState(lua_State* L) {
  ...
  if(!lua_isstring(L,3)) SWIG_fail_arg("DAVA::AutotestingSystemLua::ReadState",3,"DAVA::String const &");
...
static int _wrap_AutotestingSystemLua_WriteState(lua_State* L) {
  ...
  if(!lua_isstring(L,4)) SWIG_fail_arg("DAVA::AutotestingSystemLua::WriteState",4,"DAVA::String const &");
