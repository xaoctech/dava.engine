...
public:
    ...
    */
     ...
     */
    RefPtr<Texture> MakeScreenshot(UIControl* control, const PixelFormat format, bool updateControl = true, bool clearAlpha = false);
     ...
     */
    RefPtr<Texture> MakeScreenshot(UIControl* control, const PixelFormat format, Function<void(Texture*)> callback, bool updateControl = true, bool clearAlpha = false);
     ...
     */
    void MakeScreenshot(UIControl* control, Texture* screenshot, bool updateControl = true, bool clearAlpha = false);
    ...
    * \param callback function which be called after render
    */
    void MakeScreenshot(UIControl* control, Texture* screenshot, Function<void(Texture*)> callback, bool updateControl = true, bool clearAlpha = false, const rhi::Viewport& viewport = rhi::Viewport());
...
private:
    ...
    void MakeScreenshotInternal(UIControl* control, Texture* screenshot, Function<void(Texture*)> callback, bool updateControl, bool clearAlpha, const rhi::Viewport& viewport = rhi::Viewport());
