...
namespace DAVA
{
class UIDebugRenderComponent : public UIBaseComponent<UIComponent::DEBUG_RENDER_COMPONENT>
{
    DAVA_VIRTUAL_REFLECTION(UIDebugRenderComponent, UIBaseComponent<UIComponent::DEBUG_RENDER_COMPONENT>);
