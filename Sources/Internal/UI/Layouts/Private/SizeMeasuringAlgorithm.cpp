...
DAVA_VIRTUAL_REFLECTION_IMPL(SizeMeasuringAlgorithm)
{
    ...
    .Method("min", &SizeMeasuringAlgorithm::Min)[M::ArgNames("a", "b")]
    .Method("max", &SizeMeasuringAlgorithm::Max)[M::ArgNames("a", "b")]
    .Method("clamp", &SizeMeasuringAlgorithm::Clamp)[M::ArgNames("val", "a", "b")]
    .End();
}
