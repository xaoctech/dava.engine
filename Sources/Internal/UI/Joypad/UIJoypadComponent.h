...
public:
    ...
    */
    ...
    /**
        Get touch id the joypad is activated with. Can only be retrieved when joypad is active.
    */
    uint32 GetActiveTouchId() const;

    /**
        Set touch id the joypad is activated with
    */
    void SetActiveTouchId(uint32 touchId);
