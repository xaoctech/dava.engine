...
DAVA_VIRTUAL_REFLECTION_IMPL(Entity)
{
    ...
    .Method("GetComponent<TransformComponent>", &Entity::GetComponent<TransformComponent>)
    .Method("GetComponent<RenderComponent>", &Entity::GetComponent<RenderComponent>)
    .Method("Clone", &Entity::CloneWithoutDst)
    .Method("GetScene", &Entity::GetScene)
    .Method("AddEntity", &Entity::AddNode)
    .Method("RemoveEntity", &Entity::RemoveNode)
    .Method<Entity* (Entity::*)(const String&)>("FindByName", &Entity::FindByName)
    .End();
}
...
{
    return FindByName(FastName(name.c_str()));
}
...
{
    GetComponent<TransformComponent>()->SetWorldTransform(newMatrix);
}
