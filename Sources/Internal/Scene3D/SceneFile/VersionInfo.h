...
static const int32 SPEED_TREE_POLYGON_GPROUPS_PIVOT_SCENE_VERSION = 22; // convert EVF_PIVOT -> EVF_PIVOT4; EVF_PIVOT depricated

static const int32 SCENE_FILE_CURRENT_VERSION = SPEED_TREE_POLYGON_GPROUPS_PIVOT_SCENE_VERSION;
