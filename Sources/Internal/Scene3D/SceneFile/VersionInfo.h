...
static const int32 SPEED_TREE_COMPONENT_VALIDATION_SCENE_VERSION = 23; //remove extra SpeedTreeComponents

static const int32 SCENE_FILE_CURRENT_VERSION = SPEED_TREE_COMPONENT_VALIDATION_SCENE_VERSION;
