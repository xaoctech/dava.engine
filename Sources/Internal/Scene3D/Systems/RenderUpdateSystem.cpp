...
{
    ReflectionRegistrator<RenderUpdateSystem>::Begin()[M::SystemTags("base")]
    .ConstructorByPointer<Scene*>()
    .Method("Process", &RenderUpdateSystem::Process)[M::SystemProcessInfo(SPI::Group::EngineEnd, SPI::Type::Normal, 7.0f)]
    .End();
}
