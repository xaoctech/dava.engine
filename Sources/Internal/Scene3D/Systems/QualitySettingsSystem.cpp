...
QualitySettingsSystem::QualitySettingsSystem()
{
    ...
    qualityGroups[QualityGroup::Scattering].values.emplace(FastName("0: Ultra Low"), ScatteringQuality(1));
    qualityGroups[QualityGroup::Scattering].values.emplace(FastName("1: Low"), ScatteringQuality(8));
    qualityGroups[QualityGroup::Scattering].values.emplace(FastName("2: High"), ScatteringQuality(16));
    qualityGroups[QualityGroup::Scattering].values.emplace(FastName("3: Ultra"), ScatteringQuality(32));
