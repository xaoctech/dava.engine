...
public:
    ...
    inline const Matrix4& GetLocalTransform() const;
...
const Matrix4& TransformComponent::GetWorldTransform() const
{
    return worldMatrix;
}

const Matrix4& TransformComponent::GetLocalTransform() const
{
    return localMatrix;
}
