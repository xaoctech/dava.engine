...
DAVA_VIRTUAL_REFLECTION_IMPL(SkeletonComponent::Joint)
{
    ...
    .Field("bindTransform", &SkeletonComponent::Joint::bindTransform)[M::DisplayName("Bind Transform")]
    .Field("bindTransformInv", &SkeletonComponent::Joint::bindTransformInv)[M::DisplayName("Bind Transform Inverse")]
    .End();
}
