...
public:
    struct ClipResult
    {
        Vector<RenderObject*> geometryArray;
...
public:
    ...
    virtual void Clip(Camera* camera, RenderHierarchy::ClipResult& visibilityArray, uint32 visibilityCriteria) = 0;
...
class LinearRenderHierarchy : public RenderHierarchy
{
    ...
    void Clip(Camera* camera, RenderHierarchy::ClipResult& visibilityArray, uint32 visibilityCriteria) override;
