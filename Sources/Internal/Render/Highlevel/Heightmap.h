...
public:
    ...
    Vector3 GetPoint(int32 x, int32 y, const AABBox3& bbox) const;
    ...
    void UpdateHeightmap(const Vector<uint16>& inputData, const Rect2i& rect);
...
inline Vector3 Heightmap::GetPoint(int32 x, int32 y, const AABBox3& bbox) const
{
    Vector3 res;
