...
public:
    ...
    DAVA_DEPRECATED(void GetDataNodes(Set<DataNode*>& dataNodes) override);
...
protected:
    ...
    void SetPageMaterial(uint32 layerIndex, uint32 materialIndex, NMaterial* material) const;
    ...
    friend class SceneFileConverter;
