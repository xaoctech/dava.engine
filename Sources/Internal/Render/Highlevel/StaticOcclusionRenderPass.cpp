    ...
    : RenderPass(name)
{
    ...
    AddRenderLayer(new RenderLayer(RENDER_LAYER_OPAQUE_ID, sortingFlags));
    AddRenderLayer(new RenderLayer(RENDER_LAYER_AFTER_OPAQUE_ID, sortingFlags));
    //GFX_COMPLETE - check sky object is not counted in static occlusion
    AddRenderLayer(new RenderLayer(RENDER_LAYER_ALPHA_TEST_LAYER_ID, sortingFlags));
    AddRenderLayer(new RenderLayer(RENDER_LAYER_WATER_ID, sortingFlags));

    sortingFlags = RenderBatchArray::SORT_THIS_FRAME | RenderBatchArray::SORT_BY_DISTANCE_BACK_TO_FRONT;
    AddRenderLayer(new RenderLayer(RENDER_LAYER_TRANSLUCENT_ID, sortingFlags));
    AddRenderLayer(new RenderLayer(RENDER_LAYER_AFTER_TRANSLUCENT_ID, sortingFlags));
                                                   ...
                                                   uint32 blockIndex)
{
    ...
    passConfig.name = "StaticOcclusion";
