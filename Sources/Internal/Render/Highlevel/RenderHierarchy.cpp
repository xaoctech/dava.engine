...
namespace DAVA
{
void RenderHierarchy::ClipResult::Clear()
{
    decalArray.clear();
    lightArray.clear();
    probeArray.clear();
...
void RenderHierarchy::ClipResult::AddObject(RenderObject* ro)
{
    switch (ro->GetType())
    {
    case RenderObject::TYPE_DECAL:
        decalArray.push_back(DynamicTypeCheck<DecalRenderObject*>(ro));
        break;

    case RenderObject::TYPE_LIGHT:
    {
    ...
    case RenderObject::TYPE_REFLECTION_PROBE:
        probeArray.push_back(DynamicTypeCheck<ReflectionProbe*>(ro));
        break;
