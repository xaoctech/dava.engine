...
ShaderDescriptor* GetShaderDescriptor(const FastName& name, const UnorderedMap<FastName, int32>& inputDefines)
{
    DVASSERT(initialized);

    UnorderedMap<FastName, int32> defines = inputDefines;
