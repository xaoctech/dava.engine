...
void InitDynamicParamNames()
{
    if (DYNAMIC_PARAM_NAMES[0].IsValid() == false)
    {
        ...
        DYNAMIC_PARAM_NAMES[DynamicBindings::PARAM_STATIC_SHADOW_AO_UV] = FastName("shadowaoUV");
        DYNAMIC_PARAM_NAMES[DynamicBindings::PARAM_STATIC_SHADOW_AO_SIZE] = FastName("shadowaoSize");
