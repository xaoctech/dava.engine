...
public:
    ...
    static const FastName LANDSCAPE_DEBUG;
    static const FastName LANDSCAPE;
    ...
    static const FastName DECORATION;
    static const FastName DECORATION_CULLFACE;
    ...
    static const FastName CUBE_FACE_BLIT;
    static const FastName FORWARD_PBS;
    static const FastName FORWARD_PBS_VERTEX_AO;
    ...
    static const FastName FORWARD_PBS_MULTITEXTURED;
    static const FastName FORWARD_PBS_DETAIL_NORMAL;
    ...
    static const FastName LANDSCAPE_BRUSH;
};
...
public:
    ...
    static const FastName TEXTURE_TANGENTMAP;
    static const FastName TEXTURE_DECALMASK;
    static const FastName TEXTURE_DECALTEXTURE;
    static const FastName TEXTURE_SHADOWMAP_SKYACC;
    static const FastName TEXTURE_HEIGHT;
    ...
    static const FastName TEXTURE_ENVIRONMENT_MAP;

    static const FastName TEXTURE_GLOBAL_REFLECTION;
    static const FastName TEXTURE_GLOBAL_SKY;
    static const FastName TEXTURE_LOCAL_REFLECTION;
...
public:
    ...
    static const FastName ENVIRONMENT_COLOR_PROPERTY;
    static const FastName FORCED_SHADOW_DIRECTION_PARAM;
    static const FastName PARAM_SPECULAR_SCALE;
    static const FastName PARAM_LIGHTMAP_TEXTURE_SIZE;
...
public:
    ...
    static const FastName FLAG_NORMAL_BLEND_MODE;
    static const FastName FLAG_USE_DETAIL_NORMAL_AO;
    ...
    static const FastName FLAG_BLEND_LANDSCAPE_HEIGHT;
    ...
    static const FastName FLAG_USE_BAKED_LIGHTING;
    static const FastName FLAG_ALBEDO_ALPHA_MASK;
    ...
    static const FastName FLAG_VIEWMODE;
    ...
    static const FastName FLAG_LANDSCAPE_TESSELLATION_COLOR;
    static const FastName FLAG_LANDSCAPE_VT_PAGE;
    ...
    static const FastName FLAG_COPY_GBUFFER_0;
    static const FastName FLAG_COPY_GBUFFER_1;
    static const FastName FLAG_COPY_GBUFFER_2;
    static const FastName FLAG_COPY_GBUFFER_3;

    static const FastName FLAG_PARTICLES_DEBUG_SHOW_HEATMAP;

    static const FastName FLAG_LANDSCAPE_LAYERS_COUNT;
    ...
    static const FastName FLAG_USE_FRAMEBUFFER_FETCH;
...
public:
    ...
    static const DAVA::String MaterialType;
