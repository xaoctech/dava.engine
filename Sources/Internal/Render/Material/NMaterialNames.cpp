...
const FastName NMaterialName::FORWARD_PBS_MULTITEXTURED = FastName("~res:/Materials2/PBS.Multitexturing.material");
const FastName NMaterialName::FORWARD_PBS_DETAIL_NORMAL = FastName("~res:/Materials2/DetailNormal.material");
