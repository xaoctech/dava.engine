...
const FastName NMaterialName::TILE_MASK = FastName("~res:/Materials2/TileMask.material");
const FastName NMaterialName::LANDSCAPE_DEBUG = FastName("~res:/Materials2/Landscape.Debug.material");
const FastName NMaterialName::LANDSCAPE = FastName("~res:/Materials2/Landscape.material");
...
const FastName NMaterialName::DECORATION = FastName("~res:/Materials2/Decoration.material");
const FastName NMaterialName::DECORATION_CULLFACE = FastName("~res:/Materials2/Decoration.Cullface.material");
...
const FastName NMaterialName::LANDSCAPE_BRUSH = FastName("~res:/Materials2/LandscapeBrush.material");
...
const FastName NMaterialName::FORWARD_PBS = FastName("~res:/Materials2/PBS.material");
const FastName NMaterialName::FORWARD_PBS_VERTEX_AO = FastName("~res:/Materials2/PBS.VertexAO.material");
const FastName NMaterialName::FORWARD_PBS_TRANSMITTANCE = FastName("~res:/Materials2/PBS.Transmittance.material");
const FastName NMaterialName::FORWARD_PBS_TRANSMITTANCE_BILLBOARDS = FastName("~res:/Materials2/PBS.Transmittance.Billboards.material");

const FastName NMaterialName::FORWARD_PBS_SPEEDTREE = FastName("~res:/Materials2/PBS.SpeedTree.material");
const FastName NMaterialName::FORWARD_PBS_SPEEDTREE_TRANSMITTANCE = FastName("~res:/Materials2/PBS.Transmittance.SpeedTree.material");
...
const FastName NMaterialTextureName::TEXTURE_TANGENTMAP("tangentmap");
...
const FastName NMaterialTextureName::TEXTURE_SHADOWMAP_SKYACC("shadowaotexture");
const FastName NMaterialTextureName::TEXTURE_HEIGHT("heighttexture");
...
const FastName NMaterialTextureName::TEXTURE_ENVIRONMENT_MAP("environmentMap");

const FastName NMaterialTextureName::TEXTURE_GLOBAL_REFLECTION("globalReflection");
const FastName NMaterialTextureName::TEXTURE_GLOBAL_SKY("globalSky");
const FastName NMaterialTextureName::TEXTURE_LOCAL_REFLECTION("localReflection");
...
const FastName NMaterialParamName::ENVIRONMENT_COLOR_PROPERTY = FastName("environmentColor");
...
const FastName NMaterialParamName::PARAM_LIGHTMAP_TEXTURE_SIZE("lightmapTextureSize");
...
const FastName NMaterialFlagName::FLAG_NORMAL_BLEND_MODE = FastName("NORMAL_BLEND_MODE");
const FastName NMaterialFlagName::FLAG_USE_DETAIL_NORMAL_AO = FastName("USE_DETAIL_NORMAL_AO");
...
const FastName NMaterialFlagName::FLAG_USE_BAKED_LIGHTING = FastName("USE_BAKED_LIGHTING");
const FastName NMaterialFlagName::FLAG_ALBEDO_ALPHA_MASK = FastName("ALBEDO_ALPHA_MASK");
...
const FastName NMaterialFlagName::FLAG_VIEWMODE = FastName("VIEW_MODE");
...
const FastName NMaterialFlagName::FLAG_LANDSCAPE_TESSELLATION_COLOR("LANDSCAPE_TESSELLATION_COLOR");
const FastName NMaterialFlagName::FLAG_LANDSCAPE_VT_PAGE("LANDSCAPE_VT_PAGE");
const FastName NMaterialFlagName::FLAG_LANDSCAPE_PATCHES("LANDSCAPE_PATCHES");
const FastName NMaterialFlagName::FLAG_LANDSCAPE_MICRO_TESSELLATION("LANDSCAPE_MICRO_TESSELLATION");
const FastName NMaterialFlagName::FLAG_DECORATION("DECORATION");
const FastName NMaterialFlagName::FLAG_DECORATION_DRAW_LEVELS("DECORATION_DRAW_LEVELS");
const FastName NMaterialFlagName::FLAG_DECORATION_DECAL_MASK("DECORATION_DECAL_MASK");
...
const FastName NMaterialFlagName::FLAG_COPY_GBUFFER_0("COPY_GBUFFER_0");
const FastName NMaterialFlagName::FLAG_COPY_GBUFFER_1("COPY_GBUFFER_1");
const FastName NMaterialFlagName::FLAG_COPY_GBUFFER_2("COPY_GBUFFER_2");
const FastName NMaterialFlagName::FLAG_COPY_GBUFFER_3("COPY_GBUFFER_3");

const FastName NMaterialFlagName::FLAG_PARTICLES_DEBUG_SHOW_HEATMAP = FastName("HEATMAP");
const FastName NMaterialFlagName::FLAG_LANDSCAPE_LAYERS_COUNT = FastName("LANDSCAPE_LAYERS_COUNT");
...
Vector<FastName> RUNTIME_ONLY_FLAGS =
{
  ...
  NMaterialFlagName::FLAG_VIEWMODE,
  ...
  NMaterialFlagName::FLAG_LANDSCAPE_TESSELLATION_COLOR,
  NMaterialFlagName::FLAG_LANDSCAPE_VT_PAGE,
  NMaterialFlagName::FLAG_LANDSCAPE_PATCHES,
  NMaterialFlagName::FLAG_LANDSCAPE_MICRO_TESSELLATION,
...
const DAVA::String NMaterialSerializationKey::MaterialType = "materialType";
