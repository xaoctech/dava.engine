...
struct PackR16F
{
    inline void operator()(float32& r, float32& g, float32& b, float32& a, R16F* out)
    {
...
struct UnpackR16F
{
    inline void operator()(const R16F* input, float32& r, float32& g, float32& b, float32& a)
    {
