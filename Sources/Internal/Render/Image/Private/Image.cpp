...
void Image::FlipHorizontal()
{
    ...
    case FORMAT_RGBA32F:
        FlipHorizontal(reinterpret_cast<RGBA32F*>(data), width, height);
        break;
...
void Image::FlipVertical()
{
    ...
    case FORMAT_RGBA16F: // 4x16 = 64
        FlipVertical(reinterpret_cast<double*>(data), width, height);
        break;
    ...
    case FORMAT_RGBA32F:
        FlipVertical(reinterpret_cast<RGBA32F*>(data), width, height);
        break;
...
void Image::Rotate90Right()
{
    ...
    case FORMAT_RGBA32F:
        Rotate90Right(reinterpret_cast<RGBA32F*>(data), reinterpret_cast<RGBA32F*>(newData), height);
        break;
...
void Image::Rotate90Left()
{
    ...
    case FORMAT_RGBA32F:
        Rotate90Left(reinterpret_cast<RGBA32F*>(data), reinterpret_cast<RGBA32F*>(newData), height);
        break;
