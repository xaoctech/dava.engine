...
eErrorCode LibHDRHelper::ReadFile(File* infile, Vector<Image*>& imageSet, const ImageSystem::LoadingParams& loadingParams) const
{
    ...
    Logger::Info("HDR loaded, max values: [%.5f, %.5f, %.5f]", maxValue.x, maxValue.y, maxValue.z);
