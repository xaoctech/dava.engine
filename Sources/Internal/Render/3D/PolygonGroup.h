...
public:
    ...
    inline void SetIndex(int32 i, int32 index);
    ...
    eIndexFormat indexFormat = EIF_16;
    ...
    DAVA_DEPRECATED(void UpdateDataPointersAndStreamsLegacy());
...
inline eIndexFormat PolygonGroup::GetIndexFormat() const
{
    return indexFormat;
}
...
{
    index = (indexFormat == EIF_16) ? int32(reinterpret_cast<uint16*>(indexArray)[i]) : int32(reinterpret_cast<uint32*>(indexArray)[i]);
}
