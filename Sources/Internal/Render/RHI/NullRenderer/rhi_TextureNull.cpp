...
void null_Texture_ReadRegion(Handle tex, void* data, uint32 dataSize, const Rect2i& rect, uint32 level, TextureFace face)
{
}
...
void SetupDispatch(Dispatch* dispatch)
{
    ...
    dispatch->impl_Texture_ReadRegion = null_Texture_ReadRegion;
