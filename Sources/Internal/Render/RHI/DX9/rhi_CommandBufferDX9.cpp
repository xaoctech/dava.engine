                    ...
                    if (passCfg.colorBuffer[i].texture != rhi::InvalidHandle || passCfg.UsingMSAA())
                    {
                        if (i == 0)
                        {
                            ...
                            if (passCfg.UsingMSAA())
                                TextureDX9::SetAsRenderTarget(passCfg.colorBuffer[i].multisampleTexture, i, passCfg.colorBuffer[i].textureLevel, passCfg.colorBuffer[i].textureFace);
                        }
                        if (!passCfg.UsingMSAA())
                            TextureDX9::SetAsRenderTarget(passCfg.colorBuffer[i].texture, i, passCfg.colorBuffer[i].textureLevel, passCfg.colorBuffer[i].textureFace);
                        ++_D3D9_TargetCount;
                    }
