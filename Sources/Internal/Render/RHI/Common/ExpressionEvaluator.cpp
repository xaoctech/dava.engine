...
ExpressionEvaluator::SyntaxTreeNode
{
    ...
    SyntaxTreeNode()                
        : operand(0.0f),   left_i(InvalidIndex), right_i(InvalidIndex), expr_index(0),     operation(0) {};
    SyntaxTreeNode( float number, unsigned index )  
        : operand(number), left_i(InvalidIndex), right_i(InvalidIndex), expr_index(index), operation(0) {};
    SyntaxTreeNode( char op, unsigned index )
        : operand(0.0f),   left_i(InvalidIndex), right_i(InvalidIndex), expr_index(index), operation(op) {};
