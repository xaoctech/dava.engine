...
struct ResetHiddenFlagVisitor : public HLSLTreeVisitor
{
    void VisitTopLevelStatement(HLSLStatement* statement) override
    {
...
struct MarkVisibleStatementsVisitor : public HLSLTreeVisitor
{
    HLSLTree* tree = nullptr;
    ...
    void VisitFunction(HLSLFunction* node) override
    {
        node->hidden = false;
    ...
    void VisitIdentifierExpression(HLSLIdentifierExpression* node) override
    {
    ...
    void VisitType(HLSLType& type) override
    {
...
void PruneTree(HLSLTree* tree, const char* entryName)
{
