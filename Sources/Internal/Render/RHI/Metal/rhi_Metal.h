...
{
uint32 SetToRHI(Handle ps, uint32 layoutUID, const MTLPixelFormat* color_fmt, unsigned color_count, bool depth_used, bool stencil_used, id<MTLRenderCommandEncoder> ce, uint32 sampleCount);
