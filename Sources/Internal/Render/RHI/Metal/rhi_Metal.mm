...
void Metal_InitContext()
{
    ...
    _Metal_DefCmdQueue.label = @"metal_main_queue";
    ...
    depthDesc.resourceOptions = MTLResourceStorageModeMemoryless;
    ...
    stencilDesc.resourceOptions = MTLResourceStorageModeMemoryless;
...
void metal_Initialize(const InitParam& param)
{
    ...
    if (param.maxPerfQueryCount)
        PerfQueryMetal::Init(param.maxPerfQueryCount);
