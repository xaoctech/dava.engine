...
enum eRenderLayerID
{
    ...
    RENDER_LAYER_SHADOW_CASTER_ID = 9,
    RENDER_LAYER_RESOLVE_GBUFFER_ID = 10,
    RENDER_LAYER_DEFERRED_LIGHTS_ID = 11,
    RENDER_LAYER_DEFERRED_DECALS_ID = 12,
    RENDER_LAYER_SKY_ID = 13,
