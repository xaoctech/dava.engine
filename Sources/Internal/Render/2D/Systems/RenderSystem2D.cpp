...
void RenderSystem2D::BeginRenderTargetPass(const RenderTargetPassDescriptor& desc)
{
    ...
    renderTargetPassConfig.name = "rendertargetpass";
...
void RenderSystem2D::Setup2DMatrices()
{
    ...
    {
        //invert projection
        projMatrix.BuildOrtho(0.0f, targetSize.dx, 0.0f, targetSize.dy, -1.0f, 1.0f, rhi::DeviceCaps().isZeroBaseClipRange, false);
    }
    else
    {
        projMatrix.BuildOrtho(0.0f, targetSize.dx, targetSize.dy, 0.0f, -1.0f, 1.0f, rhi::DeviceCaps().isZeroBaseClipRange, false);
    }
...
void RenderSystem2D::PushBatch(const BatchDescriptor2D& batchDesc)
{
    ...
    case rhi::PRIMITIVE_POINTLIST:
        DVASSERT(0 && "Point List Unsupported"); // GFX_COMPLETE
        break;
