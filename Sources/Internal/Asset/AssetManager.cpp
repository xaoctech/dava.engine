...
FW::WatchID AssetManager::AddWatch(const String& directory)
{
    return fileWatcher.AddWatch(directory);
}

FW::WatchID AssetManager::AddWatch(const String& directory, bool recursive)
{
    return fileWatcher.AddWatch(directory, recursive);
}

void AssetManager::RemoveWatch(const String& directory)
{
    fileWatcher.RemoveWatch(directory);
}

void AssetManager::RemoveWatch(FW::WatchID watchid)
{
