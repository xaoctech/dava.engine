...
public:
    ...
    virtual ReflectedPropertie GetField(const ReflectedObject& object, const ValueWrapper* vw, const Any& key) const = 0;
    virtual Vector<ReflectedPropertie> GetFields(const ReflectedObject& object, const ValueWrapper* vw) const = 0;

    virtual bool HasMethods(const ReflectedObject& object, const ValueWrapper* vw) const = 0;
    virtual ReflectedMethod GetMethod(const ReflectedObject& object, const ValueWrapper* vw, const Any& key) const = 0;
    virtual Vector<ReflectedMethod> GetMethods(const ReflectedObject& object, const ValueWrapper* vw) const = 0;
