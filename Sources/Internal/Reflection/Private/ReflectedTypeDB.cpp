...
Vector<String> ReflectedTypeDB::GetPermanentNames()
{
    Vector<String> names;
    names.reserve(GetLocalDB()->permanentNameToReflectedTypeMap.size());
    for (const std::pair<String, ReflectedType*>& pair : GetLocalDB()->permanentNameToReflectedTypeMap)
    {
