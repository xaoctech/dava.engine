...
size_t Reflection::GetFieldsCount() const
{
    return structureWrapper->GetFieldsCount(object, valueWrapper);
}
...
Reflection::Field Reflection::GetField(size_t index) const
{
    return structureWrapper->GetField(object, valueWrapper, index);
}

Vector<Reflection::Field> Reflection::GetFields(MetaPredicate pred) const
{
    return structureWrapper->GetFields(object, valueWrapper, pred);
}

Vector<Reflection::Field> Reflection::GetFields(size_t first, size_t count) const
{
    return structureWrapper->GetFields(object, valueWrapper, first, count);
}
...
Vector<Reflection::Method> Reflection::GetMethods(MetaPredicate pred) const
{
