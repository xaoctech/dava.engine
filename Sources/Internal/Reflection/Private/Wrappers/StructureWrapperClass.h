...
public:
    ...
    Reflection::Field GetField(const ReflectedObject& object, const ValueWrapper* vw, size_t index) const override;
    ...
    Vector<Reflection::Method> GetMethods(const ReflectedObject& object, const ValueWrapper* vw, Reflection::MetaPredicate pred) const override;
