...
public:
    ...
    DAVA_DEPRECATED(ReflectedMeta(ReflectedMeta&& rm)); // visual studio 2013 requires this
...
using FloatNetPacking = Meta<Metas::FloatNetPacking>;
using Vector3NetPacking = Meta<Metas::Vector3NetPacking>;
using IntegerNetPacking = Meta<Metas::IntegerNetPacking>;

using ComparePrecision = Meta<Metas::ComparePrecision>;
using FloatQuantizeParam = Meta<Metas::FloatQuantizeParam>;
using QuaternionQuantizeParam = Meta<Metas::QuaternionQuantizeParam>;
using IntCompressParam = Meta<Metas::IntCompressParam>;
using Int64CompressParam = Meta<Metas::Int64CompressParam>;
