...
/**
    \ingroup metas
     Priority. Used to define order for fields or classes.
 */
using Order = Meta<Metas::Order>;
...
/*
     \ingroup metas
     Type that says that this field should be serialized with ReflectionSerializator
 */
using Serialize = Meta<Metas::Serialize>;
...
/**
    \ingroup metas
    Marks collection field as mutable. (Can be edited by default Add/Insert/Remove Field methods)
*/
using MutableCollection = Meta<Metas::MutableCollection>;
