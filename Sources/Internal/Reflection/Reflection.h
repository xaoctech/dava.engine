...
public:
    ...
    using MetaPredicate = bool (*)(const ReflectedMeta*);
    ...
    Reflection::Field GetField(size_t index) const;
    Vector<Field> GetFields(MetaPredicate pred = nullptr) const;
    Vector<Field> GetFields(size_t first, size_t count) const;
...
public:
    ...
    virtual Reflection::Field GetField(const ReflectedObject& object, const ValueWrapper* vw, size_t index) const = 0;
    virtual Vector<Reflection::Field> GetFields(const ReflectedObject& object, const ValueWrapper* vw, Reflection::MetaPredicate pred) const = 0;
    ...
    virtual Vector<Reflection::Method> GetMethods(const ReflectedObject& object, const ValueWrapper* vw, Reflection::MetaPredicate pred) const = 0;
