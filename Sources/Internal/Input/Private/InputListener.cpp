...
void InputListener::Listen(eInputListenerModes mode, Function<void(Vector<eInputElements>)> callback, uint32 deviceId, eInputDeviceTypes deviceTypesMask)
{
