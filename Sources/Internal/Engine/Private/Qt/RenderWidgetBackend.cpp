...
void RenderWidgetBackendImpl<TBase>::OnFrame()
{
    ...
    if (Private::EngineBackend::showingModalMessageBox == true)
    {
        return;
    }
...
template <typename TBase>
void RenderWidgetBackendImpl<TBase>::enterEvent(QEvent* e)
{
    mouseEntered.Emit();
}

template <typename TBase>
void RenderWidgetBackendImpl<TBase>::leaveEvent(QEvent* e)
{
    mouseLeaved.Emit();
}
