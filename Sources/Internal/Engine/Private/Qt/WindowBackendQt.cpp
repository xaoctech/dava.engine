...
void WindowBackend::OnResized(uint32 width, uint32 height, float32 dpi, bool isFullScreen)
{
    ...
    mainDispatcher->PostEvent(MainDispatcherEvent::CreateWindowSizeChangedEvent(window, w, h, dpi, dpi, fullscreen));
}
