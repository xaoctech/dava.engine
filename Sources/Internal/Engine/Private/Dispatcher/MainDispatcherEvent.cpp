...
MainDispatcherEvent MainDispatcherEvent::CreateWindowMouseClickEvent(Window* window, eType mouseClickEventType, uint32 button, float32 x, float32 y, uint32 clicks, bool isRelative)
{
...
MainDispatcherEvent MainDispatcherEvent::CreateWindowMouseMoveEvent(Window* window, float32 x, float32 y, bool isRelative)
{
    MainDispatcherEvent e(MOUSE_MOVE, window);
    e.timestamp = SystemTimer::Instance()->FrameStampTimeMS();
    e.mouseEvent.button = 0;
...
MainDispatcherEvent MainDispatcherEvent::CreateWindowMouseWheelEvent(Window* window, float32 x, float32 y, float32 deltaX, float32 deltaY, bool isRelative)
{
...
MainDispatcherEvent MainDispatcherEvent::CreateWindowTouchEvent(Window* window, eType touchEventType, uint32 touchId, float32 x, float32 y)
{
...
DAVA::Private::MainDispatcherEvent MainDispatcherEvent::CreateWindowDpiChangedEvent(Window* window, float32 dpi)
{
