...
ReflectedObject KeyedArchiveElementValueWrapper::GetValueObject(const ReflectedObject& object) const
{
    ...
    case VariantType::TYPE_AABBOX3:
        ...
        break;
    case VariantType::TYPE_STRING:
        result = ReflectedObject(value->stringValue);
        break;
    case VariantType::TYPE_WIDE_STRING:
        result = ReflectedObject(value->wideStringValue);
        break;
    case VariantType::TYPE_FILEPATH:
        result = ReflectedObject(value->filepathValue);
        break;
    case VariantType::TYPE_FASTNAME:
        result = ReflectedObject(value->fastnameValue);
        break;
    default:
        break;
    }
...
Vector<Reflection::Field> KeyedArchiveStructureWrapper::GetFields(const ReflectedObject& object, const ValueWrapper* vw, Reflection::MetaPredicate pred) const
{
