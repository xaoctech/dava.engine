...
public:
    ...
    */
    ...
    /**
     \brief Function to set Quaternion value to variant type variable
     \param[in] value	value to set
     */
    ...
    */
    ...
    /**
     \brief Function to return quaternion from variable. Returns pointer to the quaternion inside.
     \returns value of variable, or generate assert if variable type is different
     */
