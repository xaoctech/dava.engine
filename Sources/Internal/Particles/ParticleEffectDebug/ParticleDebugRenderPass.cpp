...
void ParticleDebugRenderPass::PrepareParticlesVisibilityArray(Camera* camera, RenderSystem* renderSystem)
{
    ...
    visibilityArray.geometryArray.erase(std::remove_if(visibilityArray.geometryArray.begin(), visibilityArray.geometryArray.end(),
                                        ...
                                        visibilityArray.geometryArray.end());

    particleBatches.Clear();
    PrepareParticlesBatchesArray(visibilityArray.geometryArray, camera);
}
