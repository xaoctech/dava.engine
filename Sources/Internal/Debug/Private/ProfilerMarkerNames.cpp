...
// Streaming
const char* ASSET_STREAMING_THREAD_READ_ROOT_ENTITY = "StreamingThread::ReadEntityFromFile";
const char* ASSET_STREAMING_THREAD_SCENE_DESERIALIZE = "StreamingThread::DeserializeEntity";
};
...
const char* DECORATION = "Decoration";

const char* CUBMAP_RENDERER = "CUBMAP_RENDERER";

const char* GBUFFER_PASS = "GBufferPass";
const char* DEFERRED_DECALS_PASS = "DeferredDecals";
const char* FORWARD_STUFF = "ForwardStuff";
const char* COPY_GBUFFERS_PASS = "Copy G-Buffers";
const char* GBUFFER_RESOLVE = "ResolveGbuffer";
const char* DEFERRED_LIGHTS = "DeferredLights";
const char* DEFERRED_DECAL_GROUP = "DeferredDecalGrouo";
const char* LANDSCAPE_PAGE_UPDATE = "LandscapePageUpdate";
