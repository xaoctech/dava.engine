...
#define DAVA_DEFINE_ENUM_BITWISE_OPERATORS(enumType) \
    inline /*constexpr*/ enumType operator|(enumType l, enumType r) { return static_cast<enumType>(static_cast<DAVA::uint32>(l) | static_cast<DAVA::uint32>(r)); } \
    inline /*constexpr*/ enumType operator&(enumType l, enumType r) { return static_cast<enumType>(static_cast<DAVA::uint32>(l) & static_cast<DAVA::uint32>(r)); } \
    inline /*constexpr*/ enumType operator^(enumType l, enumType r) { return static_cast<enumType>(static_cast<DAVA::uint32>(l) ^ static_cast<DAVA::uint32>(r)); } \
    inline /*constexpr*/ enumType& operator|=(enumType& l, enumType r) { l = l | r; return l; } \
    inline /*constexpr*/ enumType& operator&=(enumType& l, enumType r) { l = l & r; return l; } \
    inline /*constexpr*/ enumType& operator^=(enumType& l, enumType r) { l = l ^ r; return l; } \
    inline /*constexpr*/ enumType operator~(enumType e) { return static_cast<enumType>(~static_cast<DAVA::uint32>(e)); }
// clang-format on
