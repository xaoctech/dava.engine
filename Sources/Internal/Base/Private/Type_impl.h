...
inline bool Type::IsStdSmartPtr() const
{
    return flags.test(static_cast<size_t>(eTypeFlag::isStdSmartPtr));
}
...
Type* Type::Init()
{
    ...
    type.flags.set(isStdSmartPtr, is_std_smart_ptr<T>::value);
