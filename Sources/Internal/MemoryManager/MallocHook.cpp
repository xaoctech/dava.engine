...
// Do not override calloc on linux as when getting original address of malloc and friends
// dlsym can internally invoke calloc (overriden calloc) which in turn calls malloc
// but original malloc address is not obtained yet
