...
public:
    ...
    void SetCallbacks(Function<void()> updateCallback, Function<void(uint32, bool)> tagCallback, Function<void()> finishCallback = nullptr);
    void Update();
    void Finish();
...
private:
    ...
    ThreadLocalPtr<int> tlsNestedCall = { [](int*) {} };
#endif
    bool TryEnterNestedCall();
    void LeaveNestedCall();
};
