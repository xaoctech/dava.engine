...
float32 PerlinNoise3d(const Vector3& p, float32 wrap)
{
    ...
    Vector4 norm0 = TaylorInvSqrt(Vector4(g000.DotProduct(g000), g010.DotProduct(g010), g100.DotProduct(g100), g110.DotProduct(g110)));
    g000 *= norm0.x;
    g010 *= norm0.y;
    g100 *= norm0.z;
    g110 *= norm0.w;
    Vector4 norm1 = TaylorInvSqrt(Vector4(g001.DotProduct(g001), g011.DotProduct(g011), g101.DotProduct(g101), g111.DotProduct(g111)));
    g001 *= norm1.x;
    g011 *= norm1.y;
    g101 *= norm1.z;
    g111 *= norm1.w;
