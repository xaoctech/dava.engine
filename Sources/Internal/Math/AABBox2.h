...
public:
    ...
    AABBox2(const Vector2& center, float32 size);
    ...
    void AddAABBox(const AABBox2& bbox);
    ...
    bool IsIntersectLine(const Vector2& l1, const Vector2& l2) const;
    ...
    bool IntersectsSegment(const Vector2& l1, const Vector2& l2) const;
};
