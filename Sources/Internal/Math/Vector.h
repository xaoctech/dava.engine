...
//! functions
inline Vector2 Mul(const Vector2& _v1, const Vector2& _v2);
...
inline Vector3 Mul(const Vector3& _v1, const Vector3& _v2);
...
inline Vector4 Mul(const Vector4& _v1, const Vector4& _v2);
