...
public:
    ...
    Vector2(const float32* _data);
    Vector2(const Vector2& _v) = default;

    //! Set functions
    void Set(float32 _x, float32 _y);

    //! Additional functions
    void Lerp(const Vector2& _v1, const Vector2& _v2, float32 t);
    ...
    //! Additional functions
    float32 DotProduct(const Vector2& _v2) const;
    float32 CrossProduct(const Vector2& b) const;
    float32 Angle() const; // Need to normalize vector before use function
    ...
    const Vector2& operator*=(const Vector2& _v);
    const Vector2& operator/=(const Vector2& _v);
    const Vector2& operator*=(float32 f);
    const Vector2& operator/=(float32 f);
...
public:
    ...
    float32 DotProduct(const Vector3& _v) const;
    void Lerp(const Vector3& _v1, const Vector3& _v2, float32 t);
    ...
    float32 Length() const;
    float32 Normalize();
    void Clamp(float32 min, float32 max);
    ...
    const Vector3& operator*=(const Vector3& _v);
    const Vector3& operator/=(const Vector3& _v);
    const Vector3& operator*=(float32 f);
    const Vector3& operator/=(float32 f);
...
//! with scalar
Vector3 operator+(const Vector3& _v, float32 _f);
Vector3 operator+(float32 _f, const Vector3& v);
...
float32 DotProduct(const Vector3& v1, const Vector3& v2);
Vector3 Lerp(const Vector3& _v1, const Vector3& _v2, float32 t);
...
public:
    ...
    Vector4(const float32* _data);
    Vector4(const Vector3& xyz, float32 _w);
    ...
    //! Additional functions
    Vector4 CrossProduct(const Vector4& _v) const;
    float32 DotProduct(const Vector4& _v) const;
    void Lerp(const Vector4& _v1, const Vector4& _v2, float32 t);
...
Vector4 operator+(float32 _f, const Vector4& v);
...
inline float32 DistanceSquared(const Vector3& v1, const Vector3& v2)
{
