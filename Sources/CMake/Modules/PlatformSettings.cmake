...
if( APPLE )
    set(CMAKE_CONFIGURATION_TYPES "Debug;Release"  CACHE STRING
        "Semicolon separated list of supported configuration types [Debug|Release]"
        FORCE)
...
elseif ( LINUX )
    ...
    set( CMAKE_CXX_FLAGS_DEBUG    "${CMAKE_CXX_FLAGS} -O0 -D_DEBUG ${COMMON_CXX_FLAGS} ${DISABLED_WARNINGS}" )
    set( CMAKE_CXX_FLAGS_RELEASE  "${CMAKE_CXX_FLAGS} -O3 -DNDEBUG ${COMMON_CXX_FLAGS} ${DISABLED_WARNINGS}" )
...
## temporary disabled warnings for MacOS. They will be fixed and removed from this list in near future
    ...
    elseif( APPLE )
        ...
        set( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${LOCAL_DISABLED_WARNINGS}" ) # warnings as errors
    elseif( WIN32 )        
        # for server: disable warnings as error
	...
	if( APPLE )
	    set( LOCAL_DISABLED_WARNINGS "${LOCAL_DISABLED_WARNINGS} \
	        ...
	        -Wno-missing-braces \
	        -Wno-unused-variable")
	    set( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${LOCAL_DISABLED_WARNINGS}" )
	endif()
endif()
