...
##
if     ( ANDROID )
    set ( DAVA_THIRD_PARTY_STATIC_LIBRARIES_PATH  "${DAVA_THIRD_PARTY_ROOT_PATH}/lib_CMake/android/${ANDROID_NDK_ABI_NAME}" )

elseif ( IOS     )
    set ( DAVA_THIRD_PARTY_STATIC_LIBRARIES_PATH  "${DAVA_THIRD_PARTY_ROOT_PATH}/lib_CMake/ios" )

elseif ( MACOS )
    set ( DAVA_THIRD_PARTY_STATIC_LIBRARIES_PATH  "${DAVA_THIRD_PARTY_ROOT_PATH}/lib_CMake/mac" )

elseif ( WIN32 )

        if ( WINDOWS_UAP )
                set ( DAVA_THIRD_PARTY_STATIC_LIBRARIES_PATH  "${DAVA_THIRD_PARTY_ROOT_PATH}/lib_CMake/win10/$(Platform)" ) 

	elseif ( X64_MODE )
		set ( DAVA_THIRD_PARTY_STATIC_LIBRARIES_PATH  "${DAVA_THIRD_PARTY_ROOT_PATH}/lib_CMake/win/x64" ) 
	else ()
		set ( DAVA_THIRD_PARTY_STATIC_LIBRARIES_PATH  "${DAVA_THIRD_PARTY_ROOT_PATH}/lib_CMake/win/x86" ) 
	endif ()
