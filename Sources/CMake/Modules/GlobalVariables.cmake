...
elseif(WIN32 AND WINDOWS_UAP)
    if(WINDOWS_UAP_PLATFORMS MATCHES "Win32" )
        list( APPEND DAVA_PLATFORM_CURRENT_POSTFIXES WINDOWS_UAP_WIN32 )
    endif()
    if( WINDOWS_UAP_PLATFORMS MATCHES "ARM" ) 
        list( APPEND DAVA_PLATFORM_CURRENT_POSTFIXES WINDOWS_UAP_ARM )
    endif()
    if( WINDOWS_UAP_PLATFORMS MATCHES "x64" ) 
        list( APPEND DAVA_PLATFORM_CURRENT_POSTFIXES WINDOWS_UAP_X64 )
    endif()
endif()
